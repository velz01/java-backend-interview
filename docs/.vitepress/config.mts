...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [{ text: 'Жуков', link: '/zhukov/' },{ text: 'enhorse', link: '/enhorse/' },{ text: 'Таблица', link: '/table/' }],
    sidebar: {
    ...
    '/table/': [{ text: "Таблица", collapsed: false, items: [
          { text: "Core-1", link: "/table/core-1-3ab786" },
          { text: "Core-2", link: "/table/core-2-766bca" },
          ...
          { text: "ЛайфКодинг", link: "/table/layfkoding-a100e5" },
          { text: "Паттерны", link: "/table/patterny-3848a7" },
          { text: "Паттерны микросервисов", link: "/table/patterny-mikroservisov-75802b" }
        ] }]
    },
    outline: { level: [2, 3], label: 'На странице' },
    docFooter: { prev: 'Назад', next: 'Далее' },
    returnToTopLabel: 'Наверх', sidebarMenuLabel: 'Меню', darkModeSwitchLabel: 'Тема'
  }
})
