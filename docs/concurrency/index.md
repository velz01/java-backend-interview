...
## 12. Что такое монитор? Как монитор реализован в java?
...
## 13. Как работают методы wait(), notify() и notifyAll()?
...
## 14. Чем отличаются методы wait() и sleep()?
...
## 17. В каких состояниях может находиться поток?
...
## 18. Чем Runnable отличается от Callable?
...
## 19. Что такое семафор? Как он реализован в Java?
...
## 20. Что такое потоки демоны? Для чего они нужны? Как создать поток-демон?
...
## 21. Что такое приоритет потока? На что он влияет? Какой приоритет у потоков по умолчанию?
...
## 22. Как работает Thread.join()? Для чего он нужен?
...
## 23. Можно ли вызвать start() для одного потока дважды?
...
## 24. Как правильно остановить поток? Для чего нужны методы .stop(), .interrupt(), .interrupted(), .isInterrupted().
...
## 26. util. Concurrent поверхностно.
...
## 27. Stream API & ForkJoinPool. Как связаны, что это такое.
