...
## 9. Пример конфигурации Kafka Producer
...
## 12. Пример конфигурации Kafka Consumer
...
## 18. Какова роль Transactions API?
...
## 20. Какова роль AdminClient API?
...
## 21. Для чего нужен координатор группы?
...
## 22. Для чего нужен Consumer heartbeat thread?
...
## 23. Как Kafka обрабатывает сообщения?
...
## 24. Как Kafka обрабатывает задержку консюмера?
...
## 25. Для чего нужны методы subscribe() и poll()?
...
## 26. Для чего нужен метод position()?
...
## 27. Для чего нужны методы commitSync() и commitAsync()?
...
## 28. Для чего нужен идемпотентный продюсер?
...
## 29. Для чего нужен интерфейс Partitioner?
...
## 30. Для чего нужен Broker log cleaner thread?
...
## 31. Для чего нужен Kafka Mirror Maker?
...
## 32. Для чего нужна Schema Registry?
...
## 34. Как Kafka обеспечивает версионирование сообщений?
...
## 35. Как потребители получают сообщения от брокера?
...
## 36. В чем разница между Kafka Streams и Apache Flink?
...
## 37. В чем разница между Kafka Consumer и Kafka Stream?
...
## 38. В чем разница между Kafka и Flume?
...
## 39. В чем разница между Kafka и RabbitMQ?
