...
## 3. В чём разница между _«конкуренцией»_ и _«параллелизмом»_?
...
## 4. Что такое _«кооперативная многозадачность»_? Какой тип многозадачности использует Java? Чем обусловлен этот выбор?
...
## 5. Что такое _ordering_, _as-if-serial semantics_, _sequential consistency_, _visibility_, _atomicity_, _happens-before_, _mutual exclusion_, _safe publication_?
...
## 7. Что такое _«зелёные потоки»_ и есть ли они в Java?
...
## 12. Что такое _«монитор»_ в Java?
...
## 29. В чём различия между `volatile` и _Atomic_ переменными?
...
## 31. Что значит _«приоритет потока»_?
...
## 32. Что такое _«потоки-демоны»_?
...
## 34. Что значит _«усыпить»_ поток?
...
## 39. Существует ли способ решения проблемы _race condition_?
...
## 52. Что такое _ThreadLocal-переменная_?
...
## 55. Что такое _«блокирующий метод»_?
...
## 56. Что такое _«фреймворк Fork/Join»_?
...
## 58. Что такое _double checked locking Singleton_?
