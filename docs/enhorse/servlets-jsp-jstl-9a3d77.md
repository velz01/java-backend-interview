...
## 4. Что такое _«контейнер сервлетов»_?
...
## 7. Что такое _«дескриптор развертывания»_?
...
## 13. Что вы знаете о _сервлетных фильтрах_?
...
## 14. Зачем в сервлетах используются различные _listener_?
...
## 42. Что означает _URL encoding_? Как это осуществить в Java?
...
## 51. Как мы можем обеспечить _transport layer security_ для нашего веб приложения?
...
## 53. Какие основные особенности появились в спецификации _Servlet 3_?
...
## 55. Что такое _Java Server Pages (JSP)_?
...
## 62. Какая разница между _динамическим_ и _статическим_ содержимым JSP?
...
## 65. Что вы знаете о действиях JSP (_Action tag_ и _JSP Action Elements_).
...
## 66. Взаимодействие _JSP - сервлет - JSP_.
...
## 79. Что такое _JSTL (JSP Standard tag library)_?
...
## 80. Из каких групп тегов состоит библиотека _JSTL_?
...
## 84. Как сделать перенос строки в HTML средствами JSP?
...
## 85. Почему не нужно конфигурировать стандартные JSP теги в `web.xml`?
...
## 86. Как можно обработать ошибки JSP страниц?
...
## 87. Как происходит обработка ошибок с помощью JSTL?
...
## 88. Как конфигурируется JSP в дескрипторе развертывания.
...
## 91. Какая разница между `JSPWriter` и сервлетным `PrintWriter`?
...
## 92. Опишите общие практические принципы работы с JSP.
