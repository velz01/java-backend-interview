...
## 3. Какие существуют уровни модели _OSI_?
...
## 6. Чем отличаются _TCP_ и _UDP_?
...
## 8. Что такое _HTTP_ и _HTTPS_? Чем они отличаются?
...
## 10. Чем отличаются методы _GET_ и _POST_?
...
## 13. Что такое _Web application_?
...
## 14. Что такое _Application server_?
...
## 15. Чем отличаются _Web server_ и _Application server_?
...
## 16. Что такое _AJAX_? Как принципиально устроена эта технология?
...
## 22. Что такое _«авторизация»_ и _«аутентификация»_? Чем они отличаются?
