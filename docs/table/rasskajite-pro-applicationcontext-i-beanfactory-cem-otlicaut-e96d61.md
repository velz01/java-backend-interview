---
title: "Расскажите про ApplicationContext и BeanFactory, чем отличаются? В каких случаях что стоит использовать?"
outline: [2, 3]
---
...
## 1. Расскажите про аннотацию @Bean?
...
## 2. Расскажите про аннотацию @Component?
...
## 3. Чем отличаются аннотации @Bean и @Component?
...
## 4. Расскажите про аннотации @Service и @Repository. Чем они отличаются?
...
## 6. Расскажите про аннотацию @Resource
...
## 7. Расскажите про аннотацию @Inject
...
## 8. Расскажите про аннотацию @Lookup
...
## 9. Можно ли вставить бин в статическое поле? Почему?
...
## 10. Расскажите про аннотации @Primary и @Qualifier
...
## 13. Расскажите про аннотацию @Conditional
...
## 14. Расскажите про аннотацию @Profile
...
## 15. Расскажите про жизненный цикл бина, аннотации @PostConstruct и @PreDestroy()
...
## 16. Расскажите про скоупы бинов? Какой скоуп используется по умолчанию? Что изменилось в Spring 5?
...
## 18. Как спринг работает с транзакциями? Расскажите про аннотацию @Transactional.
...
REQUIRED — применяется по умолчани...

Остальные атрибуты:
rollbackFor = Exception.class - если какой-либо метод выб...
...
Помечая @Transactiona...

2. Transaction  Interceptor
В TransactionInterceptor отработает код до работы...

3. TransactionManager
Менеджер транзакций должен предоставить ответ на два во...

4. EntityManager proxy
Когда метод save() слоя Service делает вызов метода sa...

6. TransactionInterceptor
Отработает код после работы метода save(), а именно...

Вся работа происходит через прокси-объекты разных классов. Представим, что у ...

---

## 19. Расскажите про аннотации @Controller и @RestController. Чем они отличаются? К...

<span class="source-badge">Источник: Таблица</span>

@Controller - специальный тип класса, обрабатывает HTTP-запросы и часто испол...

---

## 20. Что такое ViewResolver?

<span class="source-badge">Источник: Таблица</span>

ViewResolver  - распознаватель представлений - это способ работы с представле...

---

## 21. Чем отличаются Model, ModelMap и ModelAndView?

<span class="source-badge">Источник: Таблица</span>

Model - интерфейс, представляет коллекцию пар ключ-значение Map&lt;String, Objec...

---

## 22. Расскажите про паттерн Front Controller, как он реализован в Spring?

<span class="source-badge">Источник: Таблица</span>

Front controller - обеспечивает единую точку входа для всех входящих запросов...

---

## 23. Расскажите про паттерн MVC, как он реализован в Spring?
...
## 24. Что такое АОП? Как реализовано в спринге?
...
## 25. В чем разница между Filters, Listeners and Interceptors?
...
## 26. Можно ли передать в запросе один и тот же параметр несколько раз? Как?
...
## 27. Как работает Spring Security? Как сконфигурировать? Какие интерфейсы используются?
...
## 28. Что такое SpringBoot? Какие у него преимущества? Как конфигурируется? Подробно.
...
## 29. Расскажите про нововведения Spring 5.
