...
## 4. Поясните: Виды БД и для чего их лучше использовать?
...
## 6. Поясните: Опишите основные этапы работы с базой данных при использовании JDBC.
...
## 8. Поясните, чем отличается Statement от PreparedStatement?
...
## 9. Поясните: Liquibase. Что это и для чего?
...
## 10. Для чего нужны инструменты миграции?
...
## 11. Какие именно записи создаёт liquibase во время миграции?
...
## 12. Какие именно проблемы могут возникать при параллельном доступе с использованием транзакций?
...
## 13. Какие именно существуют уровни изолированности транзакций?
...
## 14. Перечислите основные свойства транзакции.
...
## 15. Поясните, что такое _«транзакция»_?
...
## 16. Поясните, в чём отличие между кластерными и некластерными индексами?
...
## 17. Поясните: Имеет ли смысл индексировать данные, имеющие небольшое количество возможных значений?
...
## 18. Какие именно типы индексов существуют?
...
## 19. В каких случаях полное сканирование набора данных выгоднее доступа по индексу?
...
## 20. Поясните, что такое _«индексы»_? Для чего их используют? В чём заключаются их преимущества и недостатки?
...
## 21. Поясните, что такое шардирование?
...
## 23. Поясните: Репликация базы данных. Что это такое?
...
## 25. Поясните: Масштабирование. Как решить нехватку места на сервере?
...
## 27. Поясните, в чём заключаются преимущества использования JDBC?
...
## 28. Поясните: Дайте определение терминам _«простой»_, _«составной» (composite)_, _«потенциальный» (candidate)_ и _«альтернативный» (alternate)_ ключ.
...
## 29. Каким образом закрыть соединение с базой данных?
...
## 30. Каким образом осуществляется запрос к базе данных и обработка результатов?
...
## 31. Каким образом установить соединение с базой данных?
...
## 34. Поясните: При помощи чего формируются запросы к базе данных?
...
## 35. Поясните, что такое _«внешний ключ» (foreign key)_?
...
## 36. Поясните, что такое _«денормализация»_? Для чего она применяется?
...
## 37. Поясните, что такое _«нормализация»_?
...
## 38. Поясните, что такое _«первичный ключ» (primary key)_? Каковы критерии его выбора?
...
## 39. Поясните, что такое _«система управления базами данных»_?
