...
## 1. Поясните, что такое _«база данных»_?
...
## 2. Поясните, что такое _«реляционная модель данных»_?
...
## 3. Поясните: Liquibase. Что это и для чего?
...
## 4. Для чего нужны инструменты миграции?
...
## 5. Какие именно записи создаёт liquibase во время миграции?
...
## 6. Поясните, в чём заключаются преимущества использования JDBC?
...
## 7. Поясните: Из каких частей стоит JDBC?
...
## 8. Каким образом зарегистрировать драйвер JDBC?
...
## 9. Какие именно уровни изоляции транзакций поддерживаются в JDBC?
...
## 10. Поясните: Опишите основные этапы работы с базой данных при использовании JDBC.
...
## 11. Назовите основные классы и интерфейсы JDBC.
...
## 12. Назовите основные типы данных используемые в JDBC. Как они связаны с типами Java?
...
## 13. Поясните: Что из себя представляет JDBC URL?
...
## 15. Поясните, что такое шардирование?
...
## 17. Поясните: Репликация базы данных. Что это такое?
...
## 20. Поясните: Виды БД и для чего их лучше использовать?
...
## 21. Поясните: Масштабирование. Как решить нехватку места на сервере?
...
## 23. Поясните, в чём отличие между кластерными и некластерными индексами?
...
## 25. Поясните: Дайте определение терминам _«простой»_, _«составной» (composite)_, _«потенциальный» (candidate)_ и _«альтернативный» (alternate)_ ключ.
...
## 26. Поясните: Имеет ли смысл индексировать данные, имеющие небольшое количество возможных значений?
...
## 27. Каким образом вызвать хранимую процедуру?
...
## 28. Каким образом закрыть соединение с базой данных?
...
## 29. Каким образом осуществляется запрос к базе данных и обработка результатов?
...
## 30. Каким образом установить соединение с базой данных?
...
## 31. Какие именно проблемы могут возникать при параллельном доступе с использованием транзакций?
...
## 32. Какие именно существуют нормальные формы?
...
## 33. Какие именно существуют типы связей в базе данных? Приведите примеры.
...
## 34. Какие именно существуют уровни изолированности транзакций?
...
## 35. Какие именно типы индексов существуют?
...
## 36. В каких случаях полное сканирование набора данных выгоднее доступа по индексу?
...
## 37. Перечислите основные свойства транзакции.
...
## 38. Поясните: При помощи чего формируются запросы к базе данных?
...
## 39. Поясните, чем отличается Statement от PreparedStatement?
...
## 40. Поясните, что такое _«внешний ключ» (foreign key)_?
...
## 41. Поясните, что такое _«денормализация»_? Для чего она применяется?
...
## 42. Поясните, что такое _«индексы»_? Для чего их используют? В чём заключаются их преимущества и недостатки?
...
## 43. Поясните, что такое _«нормализация»_?
...
## 44. Поясните, что такое _«первичный ключ» (primary key)_? Каковы критерии его выбора?
