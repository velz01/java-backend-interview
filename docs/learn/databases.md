...
## 4. Репликация базы данных. Что это такое?
...
## 5. Liquibase. Что это и для чего?
...
## 6. Виды БД и для чего их лучше использовать?
...
## 7. Масштабирование. Как решить нехватку места на сервере?
...
## 8. Зачем нужны инструменты миграции?
...
## 9. Какие записи создаёт liquibase во время миграции?
...
## 12. В чем заключаются преимущества использования JDBC?
...
## 13. В чем отличие между кластерными и некластерными индексами?
...
## 15. Дайте определение терминам _«простой»_, _«составной» (composite)_, _«потенциальный» (candidate)_ и _«альтернативный» (alternate)_ ключ.
...
## 17. Имеет ли смысл индексировать данные, имеющие небольшое количество возможных значений?
...
## 18. Как вызвать хранимую процедуру?
...
## 19. Как закрыть соединение с базой данных?
...
## 20. Как зарегистрировать драйвер JDBC?
...
## 21. Как осуществляется запрос к базе данных и обработка результатов?
...
## 22. Как установить соединение с базой данных?
...
## 24. Какие существуют нормальные формы?
...
## 25. Какие существуют типы связей в базе данных? Приведите примеры.
...
## 26. Какие существуют уровни изолированности транзакций?
...
## 27. Какие типы индексов существуют?
...
## 28. Какие уровни изоляции транзакций поддерживаются в JDBC?
...
## 29. Когда полное сканирование набора данных выгоднее доступа по индексу?
...
## 30. Назовите основные свойства транзакции.
...
## 31. Опишите основные этапы работы с базой данных при использовании JDBC.
...
## 32. Перечислите основные классы и интерфейсы JDBC.
...
## 33. Перечислите основные типы данных используемые в JDBC. Как они связаны с типами Java?
...
## 34. При помощи чего формируются запросы к базе данных?
...
## 36. Чем отличается Statement от PreparedStatement?
...
## 37. Что из себя представляет JDBC URL?
...
## 40. Что такое _«внешний ключ» (foreign key)_?
...
## 41. Что такое _«денормализация»_? Для чего она применяется?
...
## 42. Что такое _«индексы»_? Для чего их используют? В чём заключаются их преимущества и недостатки?
...
## 44. Что такое _«первичный ключ» (primary key)_? Каковы критерии его выбора?
...
## 45. Что такое _«реляционная модель данных»_?
...
## 46. Что такое _«система управления базами данных»_?
