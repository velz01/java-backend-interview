...
## 4. Поясните, что такое _«абсолютный путь»_ и _«относительный путь»_?
...
## 5. Поясните, что такое _«каналы»_?
...
## 6. Поясните, что такое _«символьная ссылка»_?
...
## 7. Поясните: Инструменты для отладки приложения, течет память, все замирает - Visual VM, JMap, профилировщики
...
## 8. Каким образом выявлять и устранять узкие места производительности в REST-сервисах и микросервисных архитектурах, когда рост нагрузки (например, увеличение трафика или обращений к БД) приводит к значительно более долгой обработке запросов, чем ожидается, и какие стратегии оптимизации (в том числе архитектурные изменения и масштабирование) могут помочь достичь требуемых временных рамок отклика?
...
## 9. Поясните: Какой подход к неймингу методов позволяет ясно и однозначно отражать их функциональность, например, для методов, которые выполняют поиск с сортировкой, очистку кэша или расчёт с сохранением данных и возвратом статуса?
...
## 10. Поясните: Code first vs Design first
...
## 11. Поясните: В каких пакетах расположены классы потоков ввода/вывода?
...
## 15. Каким образом выбрать все элементы определенного каталога по критерию (например, с определенным расширением)?
...
## 16. Какие именно классы поддерживают чтение и запись потоков в компрессированном формате?
...
## 17. Какие именно классы позволяют преобразовать байтовые потоки в символьные и обратно?
...
## 18. Какие именно классы позволяют ускорить чтение/запись за счет использования буфера?
...
## 19. Какие именно методы класса `File` вы знаете?
...
## 20. Какие именно особенности NIO вы знаете?
...
## 21. Какие именно подклассы класса `InputStream` вы знаете, для чего они предназначены?
...
## 22. Какие именно подклассы класса `OutputStream` вы знаете, для чего они предназначены?
...
## 23. Какие именно подклассы класса `Reader` вы знаете, для чего они предназначены?
...
## 24. Какие именно подклассы класса `Writer` вы знаете, для чего они предназначены?
...
## 25. Какие именно режимы доступа к файлу есть у `RandomAccessFile`?
...
## 26. Поясните: Какой класс предназначен для работы с элементами файловой системы?
...
## 27. Поясните: Какой символ является разделителем при указании пути в файловой системе?
...
## 29. Перечислите основные классы потоков ввода/вывода.
...
## 30. Поясните: Существует ли возможность перенаправить потоки стандартного ввода/вывода?
...
## 31. Поясните, чем unit тесты отличаются от интеграционных?
...
## 32. Поясните, чем отличаются и что общего у `InputStream`, `OutputStream`, `Reader`, `Writer`?
...
## 33. Поясните: Что вы знаете о `RandomAccessFile`?
...
## 34. Поясните: Определение сложности алгоритма
