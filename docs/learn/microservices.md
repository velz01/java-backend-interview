...
## 3. Что такое Transactional Outbox
...
## 4. Шаблоны проектирования для микросервисов (паттерны)
...
## 6. Плюсы и минусы микросервисов
...
## 9. HTTP vs Kafka. Какой способ общения между микросервисами лучше и почему?
...
## 14. Spring Cloud Netflix Eureka
...
## 15. Spring Cloud Netflix Hystrix
...
## 16. Spring Cloud Netflix Ribbon
...
## 19. Обмен сообщениями в микросервисах
...
## 20. Преимущества и недостатки микросервисов
...
## 21. Шаблон «API-композиция» (API Composition)
...
## 22. Шаблон «API-шлюз» (API Gateway)
...
## 23. Шаблон «Автоматический выключатель» (Circuit Breaker)
...
## 24. Шаблон «Агрегация логов» (Log Aggregation)
...
## 25. Шаблон «База данных на сервис» (Database Per Service)
...
## 26. Шаблон «Бэкенды для фронтендов» (Backends for Frontends, BFF)
...
## 27. Шаблон «Внешняя конфигурация» (External Configuration)
...
## 29. Шаблон «Коляска» («Прицеп», Sidecar)
...
## 30. Шаблон «Обнаружение сервисов на стороне клиента» (Client-Side Service Discovery)
...
## 31. Шаблон «Обнаружение сервисов на стороне сервера» (Server-Side Service Discovery)
...
## 33. Шаблон «Поиск событий» (Event Sourcing)
...
## 34. Шаблон «Посредник» («Посол», Ambassador)
...
## 35. Шаблон «Проверки здоровья» (Health Check)
...
## 36. Шаблон «Разбиение по бизнес-возможностям»
...
## 37. Шаблон «Разбиение по поддоменам»
...
## 38. Шаблон «Разделение команд и запросов» (Command Query Responsibility Segregation, CQRS)
...
## 39. Шаблон «Распределенная трассировка» (Distributed Tracing)
...
## 41. Шаблон «Сборка пользовательского интерфейса на стороне клиента» (Client-Side UI Composition)
...
## 42. Шаблон «Сборка фрагментов страниц на стороне сервера» (Server-Side Page Fragment Composition)
...
## 43. Шаблон «Сине-зеленое развертывание» (Blue-Green Deployment)
...
## 44. Шаблон «Тестирование контрактов, ориентированных на потребителя» (Consumer-Driven Contract Testing)
...
## 45. Шаблон «Уровень защиты от повреждений»
...
## 46. Шаблон «Экземпляр сервиса на хост» (Service Instance Per Host)
