...
## 3. Поясните: Обмен сообщениями в микросервисах
...
## 4. Поясните: HTTP vs Kafka. Какой способ общения между микросервисами лучше и почему?
...
## 5. Поясните: Remote procedure call (RPC)
...
## 6. Поясните: Шаблон «API-шлюз» (API Gateway)
...
## 7. Поясните: Шаблон «Обнаружение сервисов на стороне клиента» (Client-Side Service Discovery)
...
## 8. Поясните: Шаблон «Обнаружение сервисов на стороне сервера» (Server-Side Service Discovery)
...
## 9. Поясните: Spring Cloud Gateway
...
## 10. Поясните: Spring Cloud Netflix Eureka
...
## 11. Поясните: Spring Cloud OpenFeign
...
## 12. Поясните: Spring Cloud Config
...
## 13. Поясните: Шаблон «Внешняя конфигурация» (External Configuration)
...
## 14. Поясните: Spring Cloud Netflix Ribbon
...
## 15. Поясните: Паттерн Circuit Breaker
...
## 16. Поясните: Шаблон «Переборка» (Bulkhead)
...
## 17. Поясните: Spring Cloud Netflix Hystrix
...
## 18. Поясните: Паттерн Saga в микросервисной архитектуре
...
## 19. Поясните: Шаблоны проектирования для микросервисов (паттерны)
...
## 21. Поясните, что такое Transactional Outbox
...
## 23. Поясните: Шаблон «Поиск событий» (Event Sourcing)
...
## 24. Поясните: Шаблон «Разделение команд и запросов» (Command Query Responsibility Segregation, CQRS)
...
## 25. Поясните: Шаблон «API-композиция» (API Composition)
...
## 26. Поясните: Шаблон «Агрегация логов» (Log Aggregation)
...
## 27. Поясните: Шаблон «База данных на сервис» (Database Per Service)
...
## 28. Поясните: Шаблон «Бэкенды для фронтендов» (Backends for Frontends, BFF)
...
## 29. Поясните: Шаблон «Душитель» (Strangler)
...
## 30. Поясните: Шаблон «Коляска» («Прицеп», Sidecar)
...
## 31. Поясните: Шаблон «Посредник» («Посол», Ambassador)
...
## 32. Поясните: Шаблон «Проверки здоровья» (Health Check)
...
## 33. Поясните: Шаблон «Разбиение по бизнес-возможностям»
...
## 34. Поясните: Шаблон «Разбиение по поддоменам»
...
## 35. Поясните: Шаблон «Распределенная трассировка» (Distributed Tracing)
...
## 36. Поясните: Шаблон «Сборка пользовательского интерфейса на стороне клиента» (Client-Side UI Composition)
...
## 37. Поясните: Шаблон «Сборка фрагментов страниц на стороне сервера» (Server-Side Page Fragment Composition)
...
## 38. Поясните: Шаблон «Сине-зеленое развертывание» (Blue-Green Deployment)
...
## 39. Поясните: Шаблон «Тестирование контрактов, ориентированных на потребителя» (Consumer-Driven Contract Testing)
...
## 40. Поясните: Шаблон «Уровень защиты от повреждений»
...
## 41. Поясните: Шаблон «Экземпляр сервиса на хост» (Service Instance Per Host)
