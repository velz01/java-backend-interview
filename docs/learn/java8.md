...
## 1. Поясните, что такое `default` методы интрефейса?
...
## 3. Поясните, что такое `LocalDateTime`?
...
## 6. Поясните, что такое `static` метод интерфейса?
...
## 7. Поясните, что такое `StringJoiner`?
...
## 8. Поясните, что такое `ZonedDateTime`?
...
## 9. Зачем нужна аннотация @FunctionalInterface
...
## 10. Зачем нужны операции Consumer, Function, Supplier?
...
## 11. Поясните: Что делает Интерфейс Function?
...
## 12. Каким образом вывести на экран 10 случайных чисел в порядке возрастания?
...
## 13. Каким образом вызывать `default` метод интерфейса в реализующем этот интерфейс классе?
...
## 14. Каким образом вызывать `static` метод интерфейса?
...
## 15. Каким образом добавить 1 неделю, 1 месяц, 1 год, 10 лет к текущей дате с использованием Date Time API?
...
## 16. Каким образом найти максимальное число в наборе?
...
## 17. Каким образом найти минимальное число в наборе?
...
## 19. Каким образом получить вторую субботу текущего месяца используя Date Time API?
...
## 20. Каким образом получить следующий вторник используя Date Time API?
...
## 21. Каким образом получить среднее значение всех чисел?
...
## 22. Каким образом получить сумму всех чисел в наборе?
...
## 23. Каким образом получить текущее время по местному времени с точностью до миллисекунд используя Date Time API?
...
## 24. Каким образом получить текущее время с точностью до миллисекунд используя Date Time API?
...
## 25. Каким образом получить текущую дату с использованием Date Time API из Java 8?
...
## 26. Каким образом создать Base64 кодировщик и декодировщик?
...
## 27. Какие именно дополнительные методы для работы с ассоциативными массивами (maps) появились в Java 8?
...
## 28. Какие именно нововведения, появились в Java 8 и JDK 8?
...
## 29. Поясните: Какой класс появился в Java 8 для кодирования/декодирования данных?
