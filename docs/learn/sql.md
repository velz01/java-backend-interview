...
## 2. Поясните, что такое DDL? Какие операции в него входят? Рассказать про них.
...
## 3. Поясните, что такое DML? Какие операции в него входят? Рассказать про них.
...
## 4. Поясните, что такое DCL? Какие операции в него входят? Рассказать про них.
...
## 7. Поясните: БД. Constraint. Какие существуют?
...
## 8. Какие именно ограничения на целостность данных существуют в SQL?
...
## 9. Поясните: C помощью SQL блокировка строки? - SELECT FOR UPDATE
...
## 10. Поясните: Каков общий синтаксис оператора `SELECT`?
...
## 11. Поясните: Виды JOIN. Как работает каждый JOIN?
...
## 12. Поясните, чем WHERE отличается от HAVING? Можем ли мы их использовать в одном запросе?
...
## 13. Поясните: UNION vs UNION ALL
...
## 14. Расскажи подробнее про ключевое слово DISTINCT?
...
## 15. Поясните, в чём разница между операторами `GROUP BY` и `DISTINCT`?
...
## 16. Зачем используется оператор `HAVING`?
...
## 17. Зачем применяется ключевое слово `UNION`?
...
## 18. Каким образом `GROUP BY` обрабатывает значение `NULL`?
...
## 19. Поясните: Что быстрее убирает дубликаты distinct или group by?
...
## 20. В каких случаях использовать JOIN, а в каких — подзапрос?
...
## 21. Поясните, что такое GROUP BY?
...
## 22. Поясните: Ключевое слово LATERAL
...
## 23. Зачем используется оператор `ORDER BY`?
...
## 24. Поясните: Что делает оператор `EXISTS`?
...
## 25. Расскажите подробнее про ACID
...
## 26. Поясните, что такое транзакции?
...
## 27. Поясните: Проблемы параллельных транзакций
...
## 28. Поясните: Блокировки и локи. Оптимистичная и Пессимистичная
...
## 29. Поясните: Индексы в SQL. Что это?
...
## 30. Какие именно виды индексов знаешь?
...
## 31. Поясните: Плюсы и минусы индексов
...
## 32. По какой причине когда много индексов, это плохо?
...
## 33. Каким образом правильно выбрать индекс?
...
## 34. Каким образом создать индекс?
...
## 35. Поясните: Оптимизация запросов. Какие существуют инструменты?
...
- **Видео:** [База по оптимизации PostgreSQL: индексы, EXPLAIN и планы выполнения](https://www.youtube.com/watch?v=gA3A_epB3So)

---

<span class="priority-badge priority-medium">🟡 Средний приоритет</span>

## 36. Поясните: EXPLAIN vs EXPLAIN ANALYZE
...
## 38. Поясните: View, materialized view. Разница между обычным и материализованным представлением?
...
## 39. Поясните: Нормализация и денормализация. Перечислите формы
...
## 40. Поясните: Оконные функции. PARTITION BY
...
## 41. Поясните, что такое _«представление» (view)_ и для чего оно применяется?
...
## 42. Поясните, что такое нормализация и денормализация? Расскажите про 3 нормальные формы?
...
## 43. Какие именно агрегатные функции вы знаете?
...
## 44. Поясните: Расскажите об основных функциях ранжирования в Transact-SQL.
...
## 45. Поясните: Уровни изолированности (read uncommitted, read committed, repeatable read, serializable)
...
## 46. Какие именно отличия между ограничениями `PRIMARY` и `UNIQUE`?
...
## 47. Каким образом работает Serializable?
...
## 48. Поясните, что такое селективность?
...
## 49. Поясните: Инструмент для сбора статистики в PostgreSQL
...
## 50. Поясните: Что делает оператор MERGE? Какие у него есть ограничения?
...
## 51. Поясните, что такое _«временная таблица»_? Для чего она используется?
...
## 52. Зачем используется Database Connection Pool? (Hikari) Исчерпание connection pool
...
## 54. Поясните: Что делает оператор `MERGE`?
...
## 55. Поясните: DELETE vs TRUNCATE
...
## 56. Поясните, что такое табличные выражения?
...
## 57. Поясните, в чём разница между `COUNT(*)` и `COUNT({column})`?
...
## 58. Поясните: Для каких числовых типов недопустимо использовать операции сложения/вычитания?
...
## 59. Зачем используются операторы `IN`, `BETWEEN`, `LIKE`?
...
## 60. Зачем используются операторы `INTERSECT`, `EXCEPT` в Transact-SQL?
...
## 61. Каким образом сделать запрос из двух баз?
...
## 62. Какие именно существуют операторы SQL?
...
## 64. Поясните: Нюансы работы с NULL в SQL. Как проверить поле на NULL?
...
## 65. Расскажите подробнее про операторы IN, BETWEEN, LIKE.
...
## 66. Поясните, чем отличается MySQL от PostgreSQL?
...
## 67. Поясните: Что означает `NULL` в SQL?
