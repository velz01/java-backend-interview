...
## 37. Поясните, в чём разница между `COUNT(*)` и `COUNT({column})`?
...
## 38. Поясните, в чём разница между операторами `GROUP BY` и `DISTINCT`?
...
## 39. Поясните: Для каких числовых типов недопустимо использовать операции сложения/вычитания?
...
## 40. Зачем используется оператор `GROUP BY`?
...
## 41. Зачем используется оператор `HAVING`?
...
## 42. Зачем используется оператор `ORDER BY`?
...
## 43. Зачем используются операторы `IN`, `BETWEEN`, `LIKE`?
...
## 44. Зачем используются операторы `INTERSECT`, `EXCEPT` в Transact-SQL?
...
## 45. Зачем применяется ключевое слово `UNION`?
...
## 46. Каким образом `GROUP BY` обрабатывает значение `NULL`?
...
## 47. Каким образом сделать запрос из двух баз?
...
## 48. Каким образом создать индекс?
...
## 49. Какие именно агрегатные функции вы знаете?
...
## 50. Какие именно ограничения на целостность данных существуют в SQL?
...
## 51. Какие именно отличия между ограничениями `PRIMARY` и `UNIQUE`?
...
## 52. Какие именно существуют операторы SQL?
...
## 53. Поясните: Каков общий синтаксис оператора `SELECT`?
...
## 54. Поясните: Какое назначение у операторов `PIVOT` и `UNPIVOT` в Transact-SQL?
...
## 55. Поясните: Может ли значение в столбце, на который наложено ограничение `FOREIGN KEY`, равняться `NULL`?
...
## 57. Поясните: Нюансы работы с NULL в SQL. Как проверить поле на NULL?
...
## 58. Поясните: Опишите разницу типов данных `DATETIME` и `TIMESTAMP`.
...
## 59. Поясните: Расскажите об основных функциях ранжирования в Transact-SQL.
...
## 60. Расскажите подробнее про операторы IN, BETWEEN, LIKE.
...
## 61. Расскажите подробнее про уровни изолированности транзакций.
...
## 62. Поясните, чем отличается MySQL от PostgreSQL?
...
## 63. Поясните: Что быстрее убирает дубликаты distinct или group by?
...
## 64. Поясните: Что делает оператор `EXISTS`?
...
## 65. Поясните: Что делает оператор `MERGE`?
...
## 66. Поясните: Что делает оператор MERGE? Какие у него есть ограничения?
...
## 67. В каких случаях использовать JOIN, а в каких — подзапрос?
...
## 68. Поясните: Что означает `NULL` в SQL?
...
## 70. Поясните, что такое _«временная таблица»_? Для чего она используется?
...
## 71. Поясните, что такое _«курсор»_?
...
## 72. Поясните, что такое _«представление» (view)_ и для чего оно применяется?
...
## 74. Поясните, что такое DCL? Какие операции в него входят? Рассказать про них.
...
## 75. Поясните, что такое DDL? Какие операции в него входят? Рассказать про них.
...
## 76. Поясните, что такое DML? Какие операции в него входят? Рассказать про них.
...
## 77. Поясните, что такое GROUP BY?
...
## 78. Поясните, что такое ORDER BY?
...
## 79. Поясните, что такое TIMESTAMP?
...
## 80. Поясните, что такое нормализация и денормализация? Расскажите про 3 нормальные формы?
...
## 81. Поясните, что такое ограничения (constraints)? Какие вы знаете?
