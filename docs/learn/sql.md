...
- **Видео:** [Оптимизация PostgreSQL: индексы, EXPLAIN, планы выполнения](https://www.youtube.com/watch?v=2YB5MKgAT5w)

---

**• Низкий приоритет**

## 1. Поясните, что такое _«SQL»_?
...
## 4. Какие именно ограничения на целостность данных существуют в SQL?
...
## 5. Какие именно отличия между ограничениями `PRIMARY` и `UNIQUE`?
...
## 6. Поясните: Может ли значение в столбце, на который наложено ограничение `FOREIGN KEY`, равняться `NULL`?
...
## 7. Поясните: Что делает оператор MERGE? Какие у него есть ограничения?
...
## 8. Поясните, что такое _«временная таблица»_? Для чего она используется?
...
## 9. Поясните, что такое DDL? Какие операции в него входят? Рассказать про них.
...
## 10. Поясните, что такое DML? Какие операции в него входят? Рассказать про них.
...
## 11. Поясните, что такое ограничения (constraints)? Какие вы знаете?
...
## 12. Поясните: Виды JOIN. Как работает каждый JOIN?
...
## 13. Поясните, чем WHERE отличается от HAVING? Можем ли мы их использовать в одном запросе?
...
## 14. Поясните: C помощью SQL блокировка строки? - SELECT FOR UPDATE
...
## 15. Поясните: UNION vs UNION ALL
...
## 16. Расскажи подробнее про ключевое слово DISTINCT?
...
## 17. Поясните, в чём разница между операторами `GROUP BY` и `DISTINCT`?
...
## 18. Зачем используется оператор `GROUP BY`?
...
## 19. Зачем используется оператор `HAVING`?
...
## 20. Зачем применяется ключевое слово `UNION`?
...
## 21. Каким образом `GROUP BY` обрабатывает значение `NULL`?
...
## 22. Поясните: Каков общий синтаксис оператора `SELECT`?
...
## 23. Поясните: Что быстрее убирает дубликаты distinct или group by?
...
## 24. В каких случаях использовать JOIN, а в каких — подзапрос?
...
## 26. Поясните, что такое GROUP BY?
...
## 27. Расскажите подробнее про ACID
...
## 28. Поясните, что такое транзакции?
...
## 29. Поясните: Проблемы параллельных транзакций
...
## 30. Расскажите подробнее про уровни изолированности транзакций.
...
## 31. Поясните: Индексы в SQL. Что это?
...
## 32. Какие именно виды индексов знаешь?
...
## 33. Поясните: Плюсы и минусы индексов
...
## 34. По какой причине когда много индексов, это плохо?
...
## 35. Каким образом правильно выбрать индекс?
...
## 36. Каким образом создать индекс?
...
## 37. Поясните: Оптимизация запросов. Какие существуют инструменты?
...
## 38. Поясните: Блокировки и локи. Оптимистичная и Пессимистичная
...
## 39. Какие инструменты применяют для оптимизации SQL-запросов?
...
## 40. Поясните: EXPLAIN vs EXPLAIN ANALYZE
...
## 42. Поясните: Уровни изолированности (read uncommitted, read committed, repeatable read, serializable)
...
## 43. Поясните, что такое _«триггер»_?
...
## 44. Поясните: Нормализация и денормализация. Перечислите формы
...
## 45. Поясните: View, materialized view. Разница между обычным и материализованным представлением?
...
## 46. Поясните, что такое селективность?
...
## 47. Поясните: Оконные функции. PARTITION BY
...
## 48. Поясните: БД. Constraint. Какие существуют?
...
## 49. Зачем используется Database Connection Pool? (Hikari) Исчерпание connection pool
...
## 50. Поясните: Хранимые процедуры
...
## 51. Поясните: DELETE vs TRUNCATE
...
## 52. Каким образом работает Serializable?
...
## 53. Поясните: cube, rollup, groupBy
...
## 54. Поясните: Инструмент для сбора статистики в PostgreSQL
...
## 55. Поясните: Ключевое слово LATERAL
...
## 56. Поясните, что такое внешний ключ?
...
## 57. Поясните, что такое табличные выражения?
...
## 58. Поясните, в чём разница между `COUNT(*)` и `COUNT({column})`?
...
## 59. Поясните: Для каких числовых типов недопустимо использовать операции сложения/вычитания?
...
## 60. Зачем используется оператор `ORDER BY`?
...
## 61. Зачем используются операторы `IN`, `BETWEEN`, `LIKE`?
...
## 62. Зачем используются операторы `INTERSECT`, `EXCEPT` в Transact-SQL?
...
## 63. Каким образом сделать запрос из двух баз?
...
## 64. Какие именно агрегатные функции вы знаете?
...
## 65. Какие именно существуют операторы SQL?
...
## 66. Поясните: Какое назначение у операторов `PIVOT` и `UNPIVOT` в Transact-SQL?
...
## 68. Поясните: Нюансы работы с NULL в SQL. Как проверить поле на NULL?
...
## 69. Поясните: Опишите разницу типов данных `DATETIME` и `TIMESTAMP`.
...
## 70. Поясните: Расскажите об основных функциях ранжирования в Transact-SQL.
...
## 71. Расскажите подробнее про операторы IN, BETWEEN, LIKE.
...
## 72. Поясните, чем отличается MySQL от PostgreSQL?
...
## 75. Поясните: Что означает `NULL` в SQL?
...
## 76. Поясните, что такое _«курсор»_?
...
## 77. Поясните, что такое _«представление» (view)_ и для чего оно применяется?
...
## 78. Поясните, что такое DCL? Какие операции в него входят? Рассказать про них.
...
## 79. Поясните, что такое ORDER BY?
...
## 80. Поясните, что такое TIMESTAMP?
...
## 81. Поясните, что такое нормализация и денормализация? Расскажите про 3 нормальные формы?
