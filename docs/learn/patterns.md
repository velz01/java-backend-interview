...
## 3. Поясните, что такое _«шаблон проектирования»_?
...
## 4. Перечислите основные характеристики шаблонов.
...
## 6. Поясните, что такое _Dependency Injection_?
...
## 7. Поясните, что такое _«антипаттерн»_? Какие антипаттерны вы знаете?
...
## 9. Какие именно паттерны проектирования используются в Spring
...
## 11. Каким образом реализуется паттер Abstract Factory?
...
## 12. В каких случаях мы можем нарушать принципы SOLID?
...
## 13. Какие именно принципы можешь назвать?
...
## 15. Поясните: Паттерн Chain of responsibility
...
## 17. Какие именно паттерны в какую группу входят?
...
## 18. Поясните: Adapter vs Decorator
...
## 20. Какие именно паттерны используются в Hibernate?
...
## 21. Какие именно паттерны используются в Spring Framework?
...
## 22. Перечислите три основные группы паттернов.
...
## 23. Поясните: Плюсы и минусы использования паттернов
...
## 24. Поясните: Приведите примеры основных шаблонов проектирования.
...
## 25. Поясните: Приведите примеры поведенческих шаблонов проектирования.
...
## 26. Поясните: Приведите примеры порождающих шаблонов проектирования.
...
## 27. Поясните: Приведите примеры структурных шаблонов проектирования.
...
## 28. Поясните: Принципы clean code
...
## 29. Расскажите подробнее про паттерн Saga
...
## 30. Расскажите подробнее про паттерн Абстрактная фабрика (Abstract Factory).
...
## 31. Расскажите подробнее про паттерн Адаптер (Adapter).
...
## 32. Расскажите подробнее про паттерн Декоратор (Decorator).
...
## 33. Расскажите подробнее про паттерн Заместитель (Proxy).
...
## 34. Расскажите подробнее про паттерн Итератор (Iterator).
...
## 35. Расскажите подробнее про паттерн Одиночка (Singleton).
...
## 36. Расскажите подробнее про паттерн Прототип (Prototype).
...
## 37. Расскажите подробнее про паттерн Строитель (Builder).
...
## 38. Расскажите подробнее про паттерн Фабричный метод (Factory Method).
...
## 39. Расскажите подробнее про паттерн Цепочка обязанностей (Chain of Responsibility).
...
## 40. Расскажите подробнее про паттерн Шаблонный метод (Template Method).
...
## 41. Поясните: Типы шаблонов проектирования.
...
## 42. Поясните: Шаблоны GRASP: Low Coupling (низкая связанность) и High Cohesion (высокая сплоченность)
