...
## 2. Поясните, что такое _«шаблон проектирования»_?
...
## 3. Поясните, что такое _Dependency Injection_?
...
## 4. Поясните, что такое _«антипаттерн»_? Какие антипаттерны вы знаете?
...
## 7. Перечислите основные характеристики шаблонов.
...
## 8. Поясните: Плюсы и минусы паттерна Singleton?
...
## 9. Какие именно существуют группы паттернов?
...
## 10. Какие именно паттерны проектирования используются в Spring
...
## 12. Каким образом реализуется паттер Abstract Factory?
...
## 13. В каких случаях мы можем нарушать принципы SOLID?
...
## 14. Какие именно принципы можешь назвать?
...
## 16. Поясните: Паттерн Chain of responsibility
...
## 18. Какие именно паттерны в какую группу входят?
...
## 19. Поясните: Adapter vs Decorator
...
## 21. Какие именно паттерны используются в Hibernate?
...
## 22. Какие именно паттерны используются в Spring Framework?
...
## 23. Перечислите три основные группы паттернов.
...
## 24. Поясните: Плюсы и минусы использования паттернов
...
## 25. Поясните: Приведите примеры основных шаблонов проектирования.
...
## 26. Поясните: Приведите примеры поведенческих шаблонов проектирования.
...
## 27. Поясните: Приведите примеры порождающих шаблонов проектирования.
...
## 28. Поясните: Приведите примеры структурных шаблонов проектирования.
...
## 29. Поясните: Принципы clean code
...
## 30. Расскажите подробнее про паттерн Saga
...
## 31. Расскажите подробнее про паттерн Абстрактная фабрика (Abstract Factory).
...
## 32. Расскажите подробнее про паттерн Адаптер (Adapter).
...
## 33. Расскажите подробнее про паттерн Декоратор (Decorator).
...
## 34. Расскажите подробнее про паттерн Заместитель (Proxy).
...
## 35. Расскажите подробнее про паттерн Итератор (Iterator).
...
## 36. Расскажите подробнее про паттерн Одиночка (Singleton).
...
## 37. Расскажите подробнее про паттерн Прототип (Prototype).
...
## 38. Расскажите подробнее про паттерн Строитель (Builder).
...
## 39. Расскажите подробнее про паттерн Фабричный метод (Factory Method).
...
## 40. Расскажите подробнее про паттерн Цепочка обязанностей (Chain of Responsibility).
...
## 41. Расскажите подробнее про паттерн Шаблонный метод (Template Method).
...
## 42. Поясните: Типы шаблонов проектирования.
