...
## 1. Поясните, что такое SOLID (каждая буква)?
...
## 2. Поясните: GOF паттерны

<div class="answer-block">

Кратко: GOF паттерны - это классические паттерны проектирования, описанные в книге _“Design Patterns: Elements of Reusable Object-Oriented Software”_, написанной четырьмя авторами (так называемой “Бандой четырёх”). Эти паттерны решают распространённые проблемы проектирования в объектно-ориентированном программировании (ООП) и помогают создавать гибкую и поддерживаемую архитектуру
...
## 4. Поясните, что такое _«шаблон проектирования»_?
...
## 5. Поясните: Плюсы и минусы паттерна Singleton?

<div class="answer-block">

Кратко: Singleton - это паттерн, который гарантирует, что у класса есть только один экземпляр и предоставляет к нему глобальную точку доступа.
...
## 6. Какие именно существуют группы паттернов?
...
## 7. Какие именно паттерны проектирования используются в Spring
...
2. **Proxy** применяется для аспектов (AOP), например, для логирования, транзакций или кэширования
...
## 8. Поясните: Паттерн Builder

<div class="answer-block">

Builder (строитель) - это порождающий паттерн проектирования, который даёт возможность пошагово и удобно создавать сложные объекты, скрывая детали их построения.
...
## 9. Каким образом реализуется паттер Abstract Factory?

<div class="answer-block">

Abstract Factory - это порождающий паттерн проектирования, который предоставляет интерфейс для создания семейств взаимосвязанных объектов без указания их конкретных классов. Он даёт возможность легко добавлять новые семейства объектов, сохраняя код гибким и расширяемым
...
## 10. В каких случаях мы можем нарушать принципы SOLID?

<div class="answer-block">

Кратко: Принципы SOLID являются руководством для написания гибкого, поддерживаемого и расширяемого кода, но бывают ситуации, когда их нарушение может быть оправдано. Рассмотрим такие случаи:
...
## 11. Какие именно принципы можешь назвать?

<div class="answer-block">

- DRY (Don't Repeat Yourself) - не повторяйся
- KISS (Keep It Super Simple / Keep It Simple Stupid) - не усложняй без нужности, делай проще
...
## 13. Поясните: Паттерн Chain of responsibility

<div class="answer-block">

Цепочка обязанностей (Chain of Responsibility) - это поведенческий паттерн проектирования, который даёт возможность передавать запросы последовательно по цепочке обработчиков. Каждый последующий обработчик решает, может ли он обработать запрос сам и стоит ли передавать запрос дальше по цепочке
...
## 14. Поясните: Паттерн Command

<div class="answer-block">

Кратко: Command (команда) - это поведенческий паттерн проектирования, который превращает запросы в объекты, позволяя передавать их как аргументы при вызове методов, ставить запросы в очередь, логировать их, а также поддерживать отмену операций
...
## 15. Какие именно паттерны в какую группу входят?
...
## 16. Поясните: Adapter vs Decorator
...
**Паттерн Decorator**
Декоратор - это структурный паттерн проектирования, который даёт возможность добавлять объектам новые обязанности на лету, помещая их в специальные обёртки
...
Кратко: SOLID — это акроним, образованный из заглавных букв первых пяти принципов ООП и проектирования. 
...
## 18. Какие именно паттерны используются в Hibernate?

<div class="answer-block">

Кратко: Domain Model – объектная модель предметной области, включающая в себя как поведение так и данные.
...
## 19. Какие именно паттерны используются в Spring Framework?

<div class="answer-block">

Кратко: Singleton - Bean scopes
...
## 20. Перечислите три основные группы паттернов.
...
Основные - основные строительные блоки, используемые для построения других шаблонов. К примеру, интерфейс.
...
## 21. Поясните: Плюсы и минусы использования паттернов
...
## 22. Поясните: Приведите примеры основных шаблонов проектирования.
...
## 23. Поясните: Приведите примеры поведенческих шаблонов проектирования.
...
+ __Посредник (Mediator)__ - Обеспечивает взаимодействие множества объектов, формируя при этом слабую связанность и избавляя объекты от нужности явно ссылаться друг на друга.
...
## 24. Поясните: Приведите примеры порождающих шаблонов проектирования.
...
+ __Фабричный метод (Factory method)__ - Делегирует создание объектов наследникам родительского класса. Это даёт возможность использовать в коде программы не специфические классы, а манипулировать абстрактными объектами на более высоком уровне.
...
## 25. Поясните: Приведите примеры структурных шаблонов проектирования.
...
## 26. Поясните: Принципы clean code
...
5. Бритва Оккама
Не создавайте ненужных сущностей без нужности.
...
## 27. Расскажите подробнее про паттерн Saga
...
## 28. Расскажите подробнее про паттерн Абстрактная фабрика (Abstract Factory).
...
Далее вы создаёте абстрактную фабрику — общий интерфейс, который содержит фабричные методы создания всех продуктов семейства (к примеру, создатьКресло, создатьДиван и создатьСтолик). Эти операции должны возвращать абстрактные типы продуктов, представленные интерфейсами, которые мы выделили ранее — Кресла, Диваны и Столики.
...
## 29. Расскажите подробнее про паттерн Адаптер (Adapter).

<div class="answer-block">

Структурный паттерн проектирования, который даёт возможность объектам с несовместимыми интерфейсами работать вместе.
...
## 30. Расскажите подробнее про паттерн Декоратор (Decorator).

<div class="answer-block">

Структурный паттерн проектирования, который даёт возможность добавлять объектам новую функциональность, оборачивая их в полезные «обёртки».
...
## 31. Расскажите подробнее про паттерн Заместитель (Proxy).

<div class="answer-block">

Структурный паттерн проектирования, который даёт возможность подставлять вместо реальных объектов специальные объекты-заменители, которые перехватывают вызовы к оригинальному объекту, позволяя сделать что-то до или после передачи вызова оригиналу.
...
## 32. Расскажите подробнее про паттерн Итератор (Iterator).

<div class="answer-block">

Кратко: Поведенческий паттерн проектирования, который даёт возможность последовательно обходить элементы составных объектов, не раскрывая их внутреннего представления.
...
## 33. Расскажите подробнее про паттерн Одиночка (Singleton).

<div class="answer-block">

Кратко: Порождающий паттрн проектирования, который гарантирует, что у класса есть только один экземпляр, и предоставляет к нему глобальную точку доступа.
...
## 34. Расскажите подробнее про паттерн Прототип (Prototype).

<div class="answer-block">

Порождающий паттерн проектирования, который даёт возможность копировать объекты, не вдаваясь в подробности их реализации.
...
## 35. Расскажите подробнее про паттерн Строитель (Builder).

<div class="answer-block">

Порождающий паттерн, который даёт возможность создавать сложные объекты пошагово. Строитель даёт возможность использовать один и тот же код строительства для получения разных представлений одного объекта.
...
## 36. Расскажите подробнее про паттерн Фабричный метод (Factory Method).

<div class="answer-block">

Кратко: Порождающий шаблон проектирования, в котором подклассы имплементируют общий интерфейс с методом для создания объектов. Переопределенный метод в каждом наследнике возвращает нужный вариант объекта.
...
## 37. Расскажите подробнее про паттерн Цепочка обязанностей (Chain of Responsibility).

<div class="answer-block">

Поведенческий паттерн проектирования, который даёт возможность передавать запросы последовательно по цепочке обработчиков. Каждый обработчик решает, может ли он обработать запрос сам и стоит ли передавать запрос дальше по цепи.
...
## 38. Расскажите подробнее про паттерн Шаблонный метод (Template Method).

<div class="answer-block">

Поведенческий паттерн проектирования, который пошагово определяет алгоритм и даёт возможность наследникам переопределять некоторые шаги алгоритма, не изменяя его структуру в целом.
...
## 39. Поясните: Типы шаблонов проектирования.
...
## 41. Поясните, что такое _«антипаттерн»_? Какие антипаттерны вы знаете?
...
__Волшебная кнопка (Magic pushbutton)__: Выполнение результатов действий пользователя в виде неподходящего (недостаточно абстрактного) интерфейса. К примеру, написание прикладной логики в обработчиках нажатий на кнопку.
...
## 42. Поясните, что такое паттерн?

<div class="answer-block">

Кратко: Паттерн - готовый шаблон/подход к решению какой-то популярной проблемы
...
## 43. Поясните: Шаблоны GRASP: Low Coupling (низкая связанность) и High Cohesion (высокая сплоченность)
