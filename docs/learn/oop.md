...
## 2. Расскажите подробнее про основные понятия ООП: _«класс»_, _«объект»_, _«интерфейс»_.
...
## 3. Поясните: Принципы ООП (наследование, инкапсуляция, полиморфизм, абстракция)
...
## 7. Поясните, что такое _«абстракция»_?
...
## 8. Каким образом проблема ромбовидного наследования решена в java?
...
## 9. Каким образом решается проблема ромбовидного наследования при наследовании интерфейсов при наличии default методов?
...
## 10. Поясните, что такое агрегация
...
## 11. Поясните, что такое ассоциация
...
## 12. Поясните, что такое композиция
...
## 13. Поясните: Является – «is a», имеет – «has a»
...
## 14. Поясните, в чём разница между _композицией_ и _агрегацией_?
...
## 15. Поясните: Что подразумевают в плане принципов ООП выражения _«является»_ и _«имеет»_?
...
## 16. Расскажите подробнее про раннее и позднее связывание.
...
## 17. Поясните, в чём заключаются преимущества и недостатки объектно-ориентированного подхода в программировании?
...
## 18. Какие именно недостатки у ООП
...
## 19. Какие именно преимущества у ООП
...
## 21. Поясните: Что представляет собой _«обмен сообщениями»_?
