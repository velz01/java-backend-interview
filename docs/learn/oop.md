...
Кратко: это парадигма программирования, центральное место в которой занимает объект. Программа - совокупность объектов (экземпляров класса). Класс - шаблон для создания объекта, характеризующийся полями и методами
...
## 2. Поясните: Принципы ООП (наследование, инкапсуляция, полиморфизм, абстракция)
...
## 3. Перечислите основные принципы _ООП_.
...
## 4. Поясните, что такое _«инкапсуляция»_?
...
## 5. Поясните, что такое _«наследование»_?
...
## 6. Поясните, что такое _«полиморфизм»_?
...
## 7. Поясните: Ассоциация, агрегация, композиция
...
## 8. Поясните: Статическое и динамическое связывание
...
## 9. Поясните: Класс, объект, интерфейс
...
## 10. Поясните: Плюсы и минусы ООП
...
## 11. Поясните: Является – «is a», имеет – «has a»
...
## 12. Поясните, в чём заключаются преимущества и недостатки объектно-ориентированного подхода в программировании?
...
## 13. Поясните, в чём разница между _композицией_ и _агрегацией_?

<div class="answer-block">

Кратко: Ассоциация обозначает связь между объектами. Композиция и агрегация — частные случаи ассоциации «часть-целое».
...
## 14. Каким образом проблема ромбовидного наследования решена в java?

<div class="answer-block">

Кратко: В Java нет поддержки множественного наследования классов.
...
## 15. Каким образом решается проблема ромбовидного наследования при наследовании интерфейсов при наличии default методов?

<div class="answer-block">

Кратко: класс, наследующий конфликтующие интерфейсы, должен явно через super определить, какой именно метод вызвать:
...
## 16. Какие именно недостатки у ООП
...
## 17. Какие именно преимущества у ООП

<div class="answer-block">

Кратко: Легко читается - не нужно выискивать в коде функции и выяснять, за что они отвечают
...
## 18. Расскажите подробнее про основные понятия ООП: _«класс»_, _«объект»_, _«интерфейс»_.

<div class="answer-block">

Кратко: __Класс__ – это способ описания сущности, определяющий состояние и поведение, зависящее от этого состояния, а также правила для взаимодействия с данной сущностью (контракт). 
...
## 19. Расскажите подробнее про раннее и позднее связывание.
...
## 20. Поясните: Что означает модификатор final? К чему он может быть применим?

<div class="answer-block">

Кратко: Для класса это означает, что класс не сможет иметь подклассов, т.е. запрещено наследование. 
...
## 21. Поясните: Что подразумевают в плане принципов ООП выражения _«является»_ и _«имеет»_?

<div class="answer-block">

Кратко: __«является»__ подразумевает наследование.
...
## 22. Поясните: Что представляет собой _«обмен сообщениями»_?
...
## 23. Поясните, что такое _«абстракция»_?

<div class="answer-block">

Кратко: _Абстрагирование_ – это способ выделить набор общих характеристик объекта, исключая из рассмотрения частные и незначимые. Соответственно, __абстракция__ – это набор всех таких характеристик.
...
## 24. Поясните, что такое _статическое_ и _динамическое связывание_?

<div class="answer-block">

Кратко: Присоединение вызова метода к телу метода называется связыванием. Если связывание проводится компилятором (компоновщиком) перед запуском программы, то оно называется _статическим_ или _ранним связыванием (early binding)_.
...
## 25. Поясните, что такое агрегация
...
## 26. Поясните, что такое ассоциация
...
## 27. Поясните, что такое композиция
