...
## 3. Дан массив с числами, одно число удалили и перемешали массив. Найти удаленное число.
...
## 4. Найти нужное число в последовательности Фибоначчи
...
## 5. Найти общее число в трёх коллекциях, не используя дополнительные структуры
...
## 7. Проверка симметричности бинарного дерева
...
## 10. Расскажите про быструю сортировку.
...
## 11. Расскажите про красно-черное дерево.
...
## 12. Расскажите про линейный и бинарный поиск.
...
## 13. Расскажите про очередь и стек.
...
## 14. Расскажите про пузырьковую сортировку.
...
## 15. Расскажите про сортировку слиянием.
...
## 16. Реверс числа без использования строк
...
## 17. Рекурсивное вычисление факториала
...
## 18. Что такое Big O? Как происходит оценка асимптотической сложности алгоритмов?
...
## 19. Что такое жадные алгоритмы? Приведите пример.
...
## 20. Что такое рекурсия? Сравните преимущества и недостатки итеративных и рекурсивных алгоритмов. С примерами.
