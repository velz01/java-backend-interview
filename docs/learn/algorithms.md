...
## 1. Поясните, что такое Big O? Как происходит оценка асимптотической сложности алгоритмов?
...
## 2. Поясните, что такое жадные алгоритмы? Приведите пример.
...
## 3. Поясните, что такое рекурсия? Сравните преимущества и недостатки итеративных и рекурсивных алгоритмов. С примерами.
...
## 4. Поясните: Алгоритм для высчитывания логарифма заданного числа по заданному основанию
...
## 5. Поясните: Вычислить квадратный корень числа, возвращая только целую часть корня.
...
## 6. Поясните: Дан массив с числами, одно число удалили и перемешали массив. Найти удаленное число.
...
## 7. Поясните: Найти нужное число в последовательности Фибоначчи
...
## 8. Поясните: Найти общее число в трёх коллекциях, не используя дополнительные структуры
...
## 9. Поясните: Последовательность Фибоначчи
...
## 10. Поясните: пузырьковая сортировка
...
## 11. Расскажите подробнее про бинарное дерево.
...
## 12. Расскажите подробнее про быструю сортировку.
...
## 13. Расскажите подробнее про красно-черное дерево.
...
## 14. Расскажите подробнее про линейный и бинарный поиск.
...
## 15. Расскажите подробнее про очередь и стек.
...
## 16. Расскажите подробнее про пузырьковую сортировку.
...
## 17. Расскажите подробнее про сортировку слиянием.
...
## 18. Поясните: Реверс числа без использования строк
...
## 19. Поясните: Рекурсивное вычисление факториала
