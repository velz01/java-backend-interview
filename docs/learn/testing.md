...
## 1. Поясните: Unit тесты. Что это и зачем?
...
## 2. Поясните: Unit тесты vs интеграционные тесты
...
## 8. Поясните, чем _stub_ отличается от _mock_?
...
## 9. Поясните: Параметризованные тесты
...
## 10. Поясните: Каким образом проверяются результаты тестов?
...
## 13. Поясните, что такое _«фикстуры»_?
