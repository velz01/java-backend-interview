...
## 3. Распределение сообщений. Как сообщения распределяются по партициям?
...
## 6. Разница между Kafka и RabbitMQ
...
## 9. Как гарантировать в Kafka идемпотентность, чтобы не было задвоений и потерь сообщений?
...
## 10. Как в Kafka гарантируется последовательность сообщений?
...
## 11. Плюсы и минусы брокеров сообщений
...
## 14. Что такое Producer и что такое Consumer?
...
## 15. Pull и push модели, в чём разница?
...
## 16. Из чего состоит Kafka кластер?
...
## 17. Повторное чтение данных из Kafka
...
## 20. Какие существуют паттерны работы с очередями?
...
## 21. Что сделать, чтобы сообщения попадали в одну партицию?
...
## 34. В чем разница между Kafka Consumer и Kafka Stream?
...
## 35. В чем разница между Kafka Streams и Apache Flink?
...
## 36. В чем разница между Kafka и Flume?
...
## 37. В чем разница между Kafka и RabbitMQ?
...
## 38. Для чего нужен Broker log cleaner thread?
...
## 39. Для чего нужен Consumer heartbeat thread?
...
## 40. Для чего нужен Kafka Mirror Maker?
...
## 42. Для чего нужен идемпотентный продюсер?
...
## 43. Для чего нужен интерфейс Partitioner?
...
## 44. Для чего нужен координатор группы?
...
## 45. Для чего нужен метод position()?
...
## 46. Для чего нужна Schema Registry?
...
## 47. Для чего нужны методы commitSync() и commitAsync()?
...
## 48. Для чего нужны методы subscribe() и poll()?
...
## 49. Как Kafka обеспечивает версионирование сообщений?
...
## 50. Как Kafka обрабатывает задержку консюмера?
...
## 51. Как Kafka обрабатывает сообщения?
...
## 52. Как потребители получают сообщения от брокера?
...
## 53. Какова роль AdminClient API?
...
## 59. Какова роль Transactions API?
...
## 67. Пример конфигурации Kafka Consumer
...
## 68. Пример конфигурации Kafka Producer
