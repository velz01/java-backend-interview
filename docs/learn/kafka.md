...
## 8. Поясните: Настройки топика Kafka
...
## 9. Зачем нужен интерфейс Partitioner?
...
## 11. Поясните: Пример конфигурации Kafka Producer
...
## 12. Зачем нужен идемпотентный продюсер?
...
## 13. Поясните: Архитектура продюсера
...
## 14. Поясните: Настройки продюсера
...
## 16. Зачем нужен Consumer heartbeat thread?
...
## 17. Поясните, в чём разница между Kafka Consumer и Kafka Stream?
...
## 18. Поясните: Пример конфигурации Kafka Consumer
...
## 19. Поясните: Kafka. Consumer Group
...
- **Статья:** [Kafka: партиции, consumer groups и rebalance](https://habr.com/ru/articles/537846/)

---

<span class="priority-badge priority-low">🟢 Низкий приоритет</span>

## 20. Поясните: Смещение (offset) в Kafka
...
## 21. Поясните: Распределение сообщений. Как сообщения распределяются по партициям?
...
## 22. Поясните: Гарантии доставки в Kafka
...
## 23. Каким образом гарантировать в Kafka идемпотентность, чтобы не было задвоений и потерь сообщений?
...
## 24. Каким образом в Kafka гарантируется последовательность сообщений?
...
## 25. Поясните: Acknowledgment в Kafka
...
## 26. Зачем нужен Broker log cleaner thread?
...
## 28. Поясните: Какова роль Transactions API?
...
## 29. Поясните: Архитектура брокера
...
## 30. Поясните: Брокеры сообщений vs Rest
...
## 31. Поясните: Что сделать, чтобы сообщения попадали в одну партицию?
...
## 32. Поясните: Какова роль AdminClient API?
...
## 33. Поясните: Какова роль Connector API?
...
## 34. Поясните: Какова роль Streams API?
...
## 35. Поясните: Плюсы и минусы брокеров сообщений
...
## 36. Поясните: Pull и push модели, в чём разница?
...
## 37. Поясните: Повторное чтение данных из Kafka
...
## 38. Каким образом работает Round Robin?
...
## 39. Какие именно существуют паттерны работы с очередями?
...
## 42. Поясните: Архитектура консюмера
...
## 48. Зачем нужен координатор группы?
...
## 50. Зачем нужна Schema Registry?
...
## 51. Зачем нужны методы commitSync() и commitAsync()?
...
## 52. Зачем нужны методы subscribe() и poll()?
...
## 53. Каким образом Kafka обеспечивает версионирование сообщений?
...
## 54. Каким образом Kafka обрабатывает задержку консюмера?
...
## 55. Каким образом Kafka обрабатывает сообщения?
...
## 56. Каким образом потребители получают сообщения от брокера?
...
## 57. Поясните: Какова роль Quota API?
...
## 58. Поясните: Настройки брокера Kafka
...
## 59. Поясните: Настройки консюмера
...
## 60. Поясните: Преимущества очередей
