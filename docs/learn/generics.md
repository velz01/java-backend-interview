...
## 2. Что такое дженерики? Для чего нужны?
...
## 4. Что такое стирание типов (Type Erasure) в Java Generics
...
## 10. Что такое сырые типы (raw type)?
