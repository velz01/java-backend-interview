...
## 1. Поясните, что такое _Appender_ в log4j?
...
## 2. Поясните, что такое _Layout_ в log4j?
...
## 3. Поясните, что такое _Logger_ в log4j?
...
## 4. Поясните: Из каких частей состоит система журналирования log4j?
...
## 5. Какие именно существуют способы конфигурирования log4j?
...
## 6. Какие именно существуют типы логов?
...
## 7. Назовите уровни журналирования в log4j? Назовите порядок их приоритетности.
