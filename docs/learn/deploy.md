...
## 1. Поясните, что такое слой? Как мы можем создать новый слой?
...
## 3. Поясните: Отличия контейнеризации от виртулизации
...
## 4. Каким образом работает Docker. Из чего состоит докер образ?
...
## 6. Поясните: Docker cmd vs entrypoint
