...
## 2. Отличия контейнеризации от виртулизации
...
## 3. Как работает Docker. Из чего состоит докер образ?
...
## 7. Поддержка сервиса в продакшене, мониторинг его работы. Общие подходы?
...
## 8. Что такое слой? Как мы можем создать новый слой?
...
## 12. Жизненный цикл проекта в Maven
...
## 13. Команда для просмотра всех процессов в Unix
