...
## 1. Поясните, что такое _«конструктор по умолчанию»_?
...
## 2. Поясните, что такое _«локальный класс»_? Каковы его особенности?
...
## 3. Поясните, что такое «анонимные классы»? Где они применяются?
...
## 4. Поясните, что такое «пул строк»?
...
## 5. Поясните, что такое сборщик мусора (garbage collector)?
...
## 6. Поясните, что такое пул строк/String pool?
...
## 7. Поясните, что такое аннотация? Зачем нужна? Как создать свою аннотацию?
...
## 9. Поясните, что такое интерфейсы?
...
## 10. Поясните, что такое класс-обертка?
...
## 11. Поясните, что такое абстрактные классы?
...
## 12. Поясните, что такое Анонимный класс
...
## 13. Поясните, что такое конструктор?
...
## 15. Поясните, что такое байт-код?
...
## 16. Поясните, что такое сериализация и для чего она нужна?
...
## 17. Расскажите подробнее про приведение типов. Что такое понижение и повышение типа?
...
## 18. Поясните, что такое _autoboxing («автоупаковка»)_ в Java и каковы правила упаковки примитивных типов в классы-обертки?
...
## 19. Поясните, что такое _checked_ и _unchecked exception_?
...
## 20. Поясните, что такое _generics_?
...
## 21. Поясните, что такое _Heap_ и _Stack_ память в Java? Какая разница между ними?
...
## 22. Поясните, что такое _Reflection_?
...
## 23. Поясните, что такое _«интернационализация»_, _«локализация»_?
...
## 24. Поясните, что такое _«статический класс»_?
...
## 25. Поясните, что такое `finalize()`? Зачем он нужен?
...
## 27. Поясните, что такое абстрактные классы? Чем они отличаются от обычных?
...
## 28. Поясните, что такое автоупаковка и автораспаковка?
...
## 29. Поясните, что такое интерфейсы? Какие модификаторы по умолчанию имеют поля и методы интерфейсов?
...
## 30. Поясните, что такое класс `Object`? Какие в нем есть методы?
...
## 31. Поясните, что такое класс Object?
...
## 32. Поясните, что такое литералы?
...
## 33. Поясните, что такое перечисления (enum)?
...
## 34. Поясните, что такое сериализация и как она реализована в Java?
...
## 35. Поясните, что такое тернарный оператор выбора?
...
## 36. Поясните: Расскажи мне про контракт и свойства Equals &amp; Hashcode
...
## 37. Поясните: Области памяти Java. Stack и heap. Что это такое?
...
## 38. Поясните: Отличия интерфейса от абстрактных классов?
...
## 40. Поясните: Какой класс называют Immutable?
...
## 42. Для чего нужен `equals()`. Чем он отличается от операции `==`?
...
## 43. Поясните: Каков порядок вызова конструкторов и блоков инициализации с учетом иерархии классов?
...
## 44. Для чего нужны и какие бывают блоки инициализации?
...
## 45. Поясните: Каким образом переменные передаются в методы — по значению или по ссылке?
...
## 46. Поясните, в чём отличие между _поверхностным_ и _глубоким_ клонированием?
...
## 47. Зачем в Java используются статические блоки инициализации?
...
## 48. Поясните: Есть ли какие-либо рекомендации о том, какие поля следует использовать при подсчете `hashCode()`?
...
## 49. Поясните: Какая основная разница между `String`, `StringBuffer`, `StringBuilder`?
...
## 50. Поясните: Каким образом из вложенного класса получить доступ к полю внешнего класса?
...
## 51. Поясните: Каким образом реализованы методы hashCode() и equals() в классе Object?
...
## 52. Поясните: Могут ли нестатические методы перегрузить статические?
...
## 53. Поясните: Могут ли у разных объектов быть одинаковые `hashCode()`?
...
## 54. Поясните: Может ли статический метод быть переопределён или перегружен?
...
## 55. Допустимо ли использовать строки в конструкции switch?
...
## 56. Допустимо ли сузить уровень доступа/тип возвращаемого значения при переопределении метода?
...
## 57. По какой причине метод `clone()` объявлен в классе `Object`, а не в интерфейсе `Cloneable`?
...
## 58. По какой причине строка является популярным ключом в `HashMap` в Java?
...
## 59. Расскажите подробнее про вложенные классы. В каких случаях они применяются?
...
## 60. Расскажите подробнее про клонирование объектов.
...
## 61. Поясните: Что делает метод `intern()` в классе `String`?.
...
## 62. Какие именно виды GC знаешь?
...
## 63. Поясните: Строки/String в Java? Из чего состоит? Нюансы
...
## 64. Поясните: Что означает static?
...
## 65. Поясните: Класс Object и его методы?
...
## 66. Поясните: Переопределение и перегрузка методов
...
## 67. Какие именно типы ссылок существуют в Java?
...
## 68. Поясните: ClassLoader в Java
...
## 69. Поясните: Есть класс `Point{int x, y;}`. Почему хэш код в виде `31 * x + y` предпочтительнее чем `x + y`?
...
## 70. Поясните: Что будет, если переопределить equals() не переопределяя hashCode()? Какие могут возникнуть проблемы?
...
## 72. Поясните, в чём разница сравнений по equals и "=="?
...
## 73. Какие именно есть модификаторы доступа? Какие применимы к классам?
...
## 74. Поясните: Расскажи что делает JIT компилятор
...
## 77. Поясните: Record-ы с Java 17. Для чего и зачем?
...
## 78. Поясните: Типы данных в Java
...
## 79. Поясните: break vs continue в цикле
...
## 80. Поясните: Автоупаковка и автораспаковка
...
## 81. Поясните: За счет чего обеспечена кроссплатформенность?
...
## 82. Какие именно виды загрузчиков классов ты знаешь?
...
## 83. Поясните: Может ли абстрактный класс быть final?
...
## 84. По какой причине не рекомендуется изменять строки в цикле?
...
## 85. Поясните: Разница между версиями Java
...
## 86. Расскажи подробнее про прогрев JVM
...
## 87. Поясните: - Правила переопределения метода hashcode().
...
## 88. Поясните: В `equals()` требуется проверять, что аргумент `equals(Object that)` такого же типа что и сам объект. В чем разница между `this.getClass() == that.getClass()` и `that instanceof MyClass`?
...
## 89. Поясните, в чём разница между членом экземпляра класса и статическим членом класса?
...
## 90. Поясните: Верно ли утверждение, что примитивные типы данных всегда хранятся в стеке, а экземпляры ссылочных типов данных в куче?
...
## 91. Поясните: Возможно ли при переопределении метода изменить: модификатор доступа, возвращаемый тип, тип аргумента или их количество, имена аргументов или их порядок; убирать, добавлять, изменять порядок следования элементов секции `throws`?
...
## 92. Поясните: Всегда ли исполняется блок `finally`?
...
## 93. Поясните: Где и для чего используется модификатор `abstract`?
...
## 94. Поясните: Где и как вы можете использовать приватный конструктор?
...
## 95. Поясните: Где разрешена инициализация статических/нестатических полей?
...
## 96. Поясните: Дайте определение понятию _«интерфейс»_. Какие модификаторы по умолчанию имеют поля и методы интерфейсов?
...
## 97. Поясните: Дайте определение понятию «конструктор».
...
## 98. Зачем используется оператор `assert`?
...
## 100. Поясните: Если `equals()` переопределен, есть ли какие-либо другие методы, которые следует переопределить?
...
## 101. Поясните: Если у класса `Point{int x, y;}` реализовать метод `equals(Object that) {(return this.x == that.x && this.y == that.y)}`, но сделать хэш код в виде `int hashCode() {return x;}`, то будут ли корректно такие точки помещаться и извлекаться из `HashSet`?
...
## 102. Поясните: К каким конструкциям Java применим модификатор `static`?
...
## 103. Каким образом написать собственное («пользовательское») исключение?
...
## 104. Каким образом получить доступ к переопределенным методам родительского класса?
...
## 105. Каким образом работает сборщик мусора?
...
## 106. Каким образом создать глубокую копию объекта? (2 способа)
...
## 107. В чём состоит принцип Write Once, Run Anywhere в Java?
...
## 108. Какие именно виды классов есть в java?
...
## 109. Какие именно есть особенности класса `String`?
...
## 110. Какие именно логические операции и операторы вы знаете?
...
## 111. Какие именно методы есть у класса Object (перечислить все)? Что они делают?
...
## 112. Какие именно модификаторы доступа есть в Java? Какие применимы к классам?
...
## 113. Какие именно недостатки у java?
...
## 114. Какие именно новые классы для работы с датами появились в java 8?
...
## 115. Какие именно нюансы у строк в Java?
...
## 116. Какие именно побитовые операции вы знаете?
...
## 117. Какие именно преимущества у java?
...
## 118. Какие именно типы данных существуют в Java?
...
## 119. Какие именно разновидности сборщиков мусора реализованы в виртуальной машине HotSpot?
...
## 120. Какие именно существуют _unchecked exception_?
...
## 121. Какие именно существуют модификаторы доступа?
...
## 122. Какие именно типы классов бывают в java?
...
## 123. Поясните: Каким образом передаются переменные в методы, по значению или по ссылке?
...
## 124. Поясните: Какими значениями по умолчанию инициализируются переменные в Java?
...
## 125. Поясните: Какими свойствами обладает порождаемое `equals()` отношение эквивалентности?
...
## 126. Поясните: Какой контракт между hashCode() и equals()?
...
## 127. Поясните: Какой способ клонирования предпочтительней?
...
## 128. В каких случаях в приложении может быть выброшено исключение `ClassCastException`?
...
## 129. Поясните: Могут ли быть конструкторы у абстрактных классов? Для чего они нужны?
...
## 130. Поясните: Могут ли быть приватные конструкторы? Для чего они нужны?
...
## 131. Поясните: Могут ли у разных объектов `(ref0 != ref1)` быть `ref0.equals(ref1) == true`?
...
## 132. Поясните: Могут ли у разных ссылок на один объект `(ref0 == ref1)` быть `ref0.equals(ref1) == false`?
...
## 133. Поясните: Может ли быть абстрактный класс без абстрактных методов?
...
## 134. Поясните: Может ли объект получить доступ к члену класса, объявленному как `private`? Если да, то каким образом?
...
## 135. Поясните: Может ли один интерфейс наследоваться от другого? От двух других?
...
## 136. Допустимо ли объявить метод абстрактным и статическим одновременно?
...
## 137. Допустимо ли реализовать метод `equals()` класса `MyClass` вот так: `class MyClass {public boolean equals(MyClass that) {return this == that;}}`?
...
## 138. Допустимо ли так реализовать метод `equals(Object that) {return this.hashCode() == that.hashCode()}`?
...
## 139. Поясните: О чем говорит ключевое слово `final`?
...
## 140. Поясните: Опишите алгоритм работы какого-нибудь сборщика мусора, реализованного в виртуальной машине HotSpot.
...
## 141. Поясните: Опишите иерархию исключений.
...
## 142. Поясните: Опишите работу блока _try-catch-finally_.
...
## 143. Поясните: Плюсы и минусы Java?
...
## 144. По какой причине `char[]` предпочтительнее `String` для хранения пароля?
...
## 145. По какой причине в некоторых интерфейсах вообще не определяют методов?
...
## 146. По какой причине не рекомендуется изменять строки в цикле? Что рекомендуется использовать?
...
## 147. По какой причине нельзя объявить метод интерфейса с модификатором `final`?
...
## 148. По какой причине нельзя реализовать hashcode() который будет гарантированно уникальным для каждого объекта?
...
## 149. Поясните: Правила переопределения equals()
...
## 150. Поясните: Правила переопределения метода `Object.equals()`.
...
## 151. Поясните: Предположим, есть метод, который может выбросить `IOException` и `FileNotFoundException` в какой последовательности должны идти блоки `catch`? Сколько блоков `catch` будет выполнено?
...
## 152. Расскажите подробнее про equals и hashcode
...
## 153. Поясните: Существуют ли в java многомерные массивы?
...
## 154. Поясните: Существуют ли ситуации, когда блок `finally` не будет выполнен?
...
## 155. Поясните, чем a.getClass().equals(A.class) отличается от a instanceOf A.class
...
## 156. Поясните, чем абстрактный класс отличается от интерфейса? В каких случаях следует использовать абстрактный класс, а в каких интерфейс?
...
## 157. Поясните, чем интерфейсы отличаются от абстрактных классов? В каких случаях следует использовать абстрактный класс, а в каких интерфейс?
...
## 158. Поясните, чем отличаются `final`, `finally` и `finalize()`?
...
## 159. Поясните, чем отличаются конструктор по умолчанию, конструктор копирования и конструктор с параметрами?
...
## 160. Поясните, чем отличаются конструкторы по-умолчанию, конструктор копирования и конструктор с параметрами?
...
## 161. Поясните, чем различаются JRE, JVM и JDK?
...
## 162. Поясните: Что вы знаете о `OutOfMemoryError`?
...
## 163. Поясните: Что вы знаете о функции `main()`?
...
## 164. Поясните: Что имеет более высокий уровень абстракции - _класс_, _абстрактный класс_ или _интерфейс_?
...
## 165. Поясните: Что означает модификатор static?
...
## 166. Поясните: Что представляет из себя ошибки класса `Error`?
...
## 167. Поясните: Что произойдёт, если в блоке инициализации возникнет исключительная ситуация?
...
## 168. Какие именно существуют особенности использования вложенных классов: статических и внутренних? В чем заключается разница между ними?
...
## 169. Поясните: Что произойдет со сборщиком мусора, если выполнение метода `finalize()` требует ощутимо много времени, или в процессе выполнения будет выброшено исключение?
