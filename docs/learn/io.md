...
## 1. Поясните, что такое _«сериализация»_?
...
## 2. Поясните, в чём проблема сериализации Singleton?
...
## 3. Каким образом изменить стандартное поведение сериализации/десериализации?
...
## 4. Каким образом исключить поля из сериализации?
...
## 5. Каким образом не допустить сериализацию?
...
## 6. Каким образом создать собственный протокол сериализации?
...
## 7. Поясните: Какая роль поля `serialVersionUID` в сериализации?
...
## 8. Какие именно существуют способы контроля за значениями десериализованного объекта
...
## 9. Поясните: Какое влияние оказывают на сериализуемость модификаторы полей `static` и `final`
...
## 10. В каких случаях стоит изменять значение поля `serialVersionUID`?
...
## 11. Поясните: Опишите процесс сериализации/десериализации с использованием `Serializable`.
...
## 12. Поясните: Что обозначает ключевое слово `transient`?
