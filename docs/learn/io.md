...
## 1. В чем проблема сериализации Singleton?
...
## 3. Как исключить поля из сериализации?
...
## 4. Как не допустить сериализацию?
...
## 5. Как создать собственный протокол сериализации?
...
## 6. Какая роль поля `serialVersionUID` в сериализации?
...
## 7. Какие существуют способы контроля за значениями десериализованного объекта
...
## 8. Какое влияние оказывают на сериализуемость модификаторы полей `static` и `final`
...
## 9. Когда стоит изменять значение поля `serialVersionUID`?
...
## 10. Опишите процесс сериализации/десериализации с использованием `Serializable`.
...
## 11. Что обозначает ключевое слово `transient`?
