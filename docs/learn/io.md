...
## 2. Поясните: Опишите процесс сериализации/десериализации с использованием `Serializable`.
...
## 3. Поясните: Какая роль поля `serialVersionUID` в сериализации?
...
## 4. Поясните: Какое влияние оказывают на сериализуемость модификаторы полей `static` и `final`
...
## 6. Поясните: Что обозначает ключевое слово `transient`?
...
## 9. Каким образом исключить поля из сериализации?
