...
## 1. Проблема N + 1. Способы решения проблемы
...
## 2. Что такое Proxy и для чего используется?
...
## 4. Что такое Hibernate, JPA, JDBC, ORM?
...
## 10. Стратегии наследования в Hibernate
...
## 12. Hibernate. Что хранится в Persistence Context? Сколько времени объект хранится в Persistence Context?
...
## 13. Statement, Prepared statement, Callable statement
...
## 14. Как создать Entity и что это такое?
...
## 15. EntityManager + EntityManagerFactory / SessionFactory + session
...
## 16. Аннотация @Query, что это такое?
...
## 24. Почему мы не можем использовать final классы в качестве Entity?
...
## 25. Dirty checking механизм Hibernate
...
## 26. Для чего нужна аннотация @Cache?
...
## 29. Для чего нужна аннотация Basic?
...
## 30. Для чего нужна аннотация Column?
...
## 32. Для чего нужна аннотация Transient?
...
## 33. Для чего нужны аннотации @Embedded и @Embeddable?
...
## 35. Как влияет операция detach на Entity объекты каждого из четырех статусов?
...
## 36. Как влияет операция merge на Entity объекты каждого из четырех статусов?
...
## 37. Как влияет операция persist на Entity объекты каждого из четырех статусов?
...
## 38. Как влияет операция refresh на Entity объекты каждого из четырех статусов?
...
## 39. Как влияет операция remove на Entity объекты каждого из четырех статусов?
...
## 41. Как мапятся даты (до java 8 и после)?
...
## 42. Как работать с кешем 2 уровня?
...
## 44. Как “смапить” коллекцию примитивов?
...
## 46. Какие два типа fetch стратегии в JPA вы знаете?
...
## 48. Какие три типа стратегий наследования мапинга (Inheritance Mapping Strategies) описаны в JPA?
...
## 49. Какие четыре статуса жизненного цикла Entity объекта (Entity Instance’s Life Cycle) вы можете перечислить?
...
## 50. Какие шесть видов блокировок (lock) описаны в спецификации JPA (или какие есть значения у enum LockModeType в JPA)?
...
## 51. Каким условиям должен удовлетворять класс чтобы являться Entity?
...
## 52. Может ли Entity класс наследоваться от других Entity классов?
...
## 53. Может ли Entity класс наследоваться от не Entity классов (non-entity classes)?
...
## 54. Может ли Entity наследоваться от других Entity классов?
...
## 55. Может ли Entity наследоваться от не-Entity классов?
...
## 56. Может ли абстрактный класс быть Entity?
...
## 57. Может ли не Entity класс наследоваться от Entity класса?
...
## 58. различия между Repository и DAO:
...
## 59. Разница между PERSIST и MERGE?
...
## 60. Расскажите про аннотации @JoinColumn и @JoinTable? Где и для чего они используются?
...
## 61. Расскажите про проблему N+1 Select и путях ее решения.
...
## 62. Что такое Criteria API и для чего он используется?
...
## 64. Что такое JPQL/HQL и чем он отличается от SQL?
...
## 65. Что такое Mapped Superclass?
...
## 66. Что такое ORM? Что такое JPA? Что такое Hibernate?
...
## 68. Что такое встраиваемый (Embeddable) класс? Какие требования JPA устанавливает к встраиваемым (Embeddable) классам?
