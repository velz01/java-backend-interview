...
## 2. Поясните, что такое Entity Graph?
...
## 3. Поясните: Hibernate. Что хранится в Persistence Context? Сколько времени объект хранится в Persistence Context?
...
## 4. Каким образом создать Entity и что это такое?
...
## 5. Поясните: EntityManager + EntityManagerFactory / SessionFactory + session
...
## 6. По какой причине мы не можем использовать final классы в качестве Entity?
...
## 7. Каким образом влияет операция detach на Entity объекты каждого из четырех статусов?
...
## 8. Каким образом влияет операция merge на Entity объекты каждого из четырех статусов?
...
## 9. Каким образом влияет операция persist на Entity объекты каждого из четырех статусов?
...
## 10. Каким образом влияет операция refresh на Entity объекты каждого из четырех статусов?
...
## 11. Каким образом влияет операция remove на Entity объекты каждого из четырех статусов?
...
## 12. Какие именно четыре статуса жизненного цикла Entity объекта (Entity Instance’s Life Cycle) вы можете перечислить?
...
## 13. Поясните: Каким условиям должен удовлетворять класс чтобы являться Entity?
...
## 16. Поясните: Может ли абстрактный класс быть Entity?
...
## 17. Поясните, что такое EntityManager?
...
## 18. Поясните: LazyInitializationException
...
## 20. Поясните: Проблемы JOIN FETCH
...
## 21. Какие именно два типа fetch стратегии в JPA вы знаете?
...
## 22. Поясните, что такое Proxy и для чего используется?
...
## 24. Поясните: Dirty checking механизм Hibernate
...
## 25. Зачем нужна аннотация @Cache?
...
## 26. Зачем нужна аннотация @Cacheable?
...
## 27. Какие именно два вида кэшей (cache) вы знаете в JPA и для чего они нужны?
...
## 28. Расскажите подробнее про проблему N+1 Select и путях ее решения.
...
## 29. Поясните: Проблема N + 1. Способы решения проблемы
...
## 30. Поясните: Жизненный цикл сущности
...
## 31. Поясните: Плюсы и минусы ORM
...
## 32. Какие именно шесть видов блокировок (lock) описаны в спецификации JPA (или какие есть значения у enum LockModeType в JPA)?
...
## 33. Поясните: Связи между таблицами в ORM
...
## 34. Поясните: Стратегии наследования в Hibernate
...
## 35. Поясните: Statement, Prepared statement, Callable statement
...
## 36. Поясните: Аннотация @Query, что это такое?
...
## 37. Поясните, что такое SQL-инъекция?
...
## 38. Поясните: Hibernate и Lombok
...
## 40. Каким образом JPA делает запросы?
...
## 41. Каким образом Hibernate генерирует SQL запросы?
...
## 43. Зачем нужна аннотация Access?
...
## 44. Зачем нужна аннотация Basic?
...
## 45. Зачем нужна аннотация Column?
...
## 46. Зачем нужна аннотация ID? Какие @GeneratedValue вы знаете?
...
## 47. Зачем нужна аннотация Transient?
...
## 48. Зачем нужны аннотации @Embedded и @Embeddable?
...
## 49. Зачем нужны аннотации @OrderBy и @OrderColumn, чем они отличаются?
...
## 50. Каким образом мапятся Enum'ы?
...
## 51. Каким образом мапятся даты (до java 8 и после)?
...
## 52. Каким образом работать с кешем 2 уровня?
...
## 53. Каким образом смапить составной ключ?
...
## 54. Каким образом “смапить” коллекцию примитивов?
...
## 55. Какие именно есть виды связей?
...
## 56. Какие именно три типа стратегий наследования мапинга (Inheritance Mapping Strategies) описаны в JPA?
...
## 57. Поясните: различия между Repository и DAO:
...
## 58. Поясните: Разница между PERSIST и MERGE?
...
## 59. Расскажите подробнее про аннотации @JoinColumn и @JoinTable? Где и для чего они используются?
...
## 60. Поясните, что такое Criteria API и для чего он используется?
...
## 63. Поясните, что такое владелец связи?
...
## 64. Поясните, что такое встраиваемый (Embeddable) класс? Какие требования JPA устанавливает к встраиваемым (Embeddable) классам?
