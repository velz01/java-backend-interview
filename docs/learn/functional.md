...
## 6. Каким образом отсортировать список строк с помощью лямбда-выражения?
...
## 7. Какие именно виды ссылок на методы вы знаете?
...
## 8. Поясните выражение `System.out::println`.
...
## 9. Поясните, что такое _«лямбда»_? Какова структура и особенности использования лямбда-выражения?
