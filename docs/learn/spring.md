...
## 1. Для чего мы используем Spring? Почему его так любят?
...
## 2. Поясните: Dependency Injection
...
## 3. Поясните: Inversion of Control
...
## 4. Поясните, что такое IoC контейнер?
...
## 5. Поясните, что такое инверсия контроля (IoC) и внедрение зависимостей (DI)? Как эти принципы реализованы в Spring?
...
## 6. Поясните: @Service, @Repository, @Component
...
## 7. Поясните: @Qualifier vs @Primary
...
## 11. Расскажите подробнее про аннотации @Primary и @Qualifier
...
## 12. Расскажите подробнее про аннотации @Service и @Repository. Чем они отличаются?
...
## 13. Расскажите подробнее про аннотацию @Autowired
...
## 14. Расскажите подробнее про аннотацию @Component?
...
## 15. Расскажите подробнее про аннотацию @ComponentScan
...
## 16. Поясните, чем отличаются аннотации @Bean и @Component?
...
## 17. Поясните: Жизненный цикл Bean. Вопросы связанные с классами, входящими в жизненный цикл бина
...
## 18. Поясните: Скоуп бинов. Web скоуп
...
## 19. Поясните, что такое ApplicationContext? Как работает под капотом
...
## 21. Расскажите подробнее про ApplicationContext и BeanFactory, чем отличаются? В каких случаях что стоит использовать?
...
## 22. Расскажите подробнее про жизненный цикл бина, аннотации @PostConstruct и @PreDestroy()
...
## 23. Расскажите подробнее про скоупы бинов? Какой скоуп используется по умолчанию? Что изменилось в Spring 5?
...
## 24. Поясните: Spring Boot vs Spring
...
## 26. Поясните: Starter в Spring. Плюсы и минусы
...
## 27. Поясните, что такое SpringBoot? Какие у него преимущества? Как конфигурируется? Подробно.
...
## 28. Поясните: Dependency management в Spring boot
...
## 29. Поясните: @Transactional. Как работает?
...
## 30. Поясните: Атрибут propagation у @Transactional
...
## 32. Поясните: Виды proxy в Spring
...
## 33. Какие именно есть атрибуты у @Transactional?
...
## 34. Поясните: @Transactional и Исключения
...
## 35. Каким образом устроен Spring Security
...
## 36. Каким образом гарантировать корректное обновление и сохранение изменений в сущностях, полученных в методе с @Transactional
...
## 37. Поясните: Spring MVC. Что это? Какие проблемы решает?
...
## 38. Поясните: Spring Security, как хранить пароль пользователя?
...
## 39. Каким образом работает Spring Security? Как сконфигурировать? Какие интерфейсы используются?
...
## 40. Каким образом спринг работает с транзакциями? Расскажите про аннотацию @Transactional.
...
## 41. Расскажите подробнее про паттерн MVC, как он реализован в Spring?
...
## 42. Поясните: @Transaction Что будет если вызвать метод из метода в одном классе при различных сценариях
...
## 43. Какие именно способы внедрения зависимостей знаешь?
...
## 44. По какой причине лучше использовать конструктор?
...
## 45. Поясните: Циклическая зависимость
...
## 46. Поясните: @Controller и @RestController
...
## 51. Каким образом работает BeanPostProcessor. Почему есть before и after initialization
...
## 52. Поясните: @Configuration. Является Configuration компонентом? Какую доп логику Configuration реализует?
...
## 53. Поясните: @ConfigurationProperties? ConfigurationProperties vs Value
...
## 54. Расскажите подробнее про аннотацию @Bean?
...
## 55. Поясните: @Conditional в Spring
...
## 56. Поясните: Spring Criteria API
...
## 60. Каким образом работает DispatcherServlet?
...
## 61. Поясните: Spring Profiles как с ними работать?
...
## 63. Поясните: Варианты обработки Exceptions в Spring
...
## 64. Поясните: Понятие Controller и Servlet в Java. Это одно и то же? Если разное, в чем отличия?
...
## 66. Для чего нужны аннотации @RequestParam и @PathVariable?
...
## 67. Поясните, что такое объект Filter? В какой момент вызывается?
...
## 68. Поясните: @ResponseBody vs ResponseEntity
...
## 69. Поясните: Блокировка по умолчанию в Spring
...
## 70. Поясните, в чём разница между Filters, Listeners and Interceptors?
...
## 71. Каким образом заинжектить коллекцию?
...
## 72. Каким образом заинжектить примитив?
...
## 73. Допустимо ли вставить бин в статическое поле? Почему?
...
## 74. Допустимо ли передать в запросе один и тот же параметр несколько раз? Как?
...
## 75. Расскажите подробнее про аннотации @Controller и @RestController. Чем они отличаются? Как вернуть ответ со своим статусом (например 213)?
...
## 76. Расскажите подробнее про аннотацию @Conditional
...
## 77. Расскажите подробнее про аннотацию @Inject
...
## 78. Расскажите подробнее про аннотацию @Lookup
...
## 79. Расскажите подробнее про аннотацию @Profile
...
## 80. Расскажите подробнее про аннотацию @Resource
...
## 81. Расскажите подробнее про нововведения Spring 5.
...
## 82. Расскажите подробнее про паттерн Front Controller, как он реализован в Spring?
...
## 83. Поясните, чем отличаются Model, ModelMap и ModelAndView?
...
## 84. Поясните, что такое ViewResolver?
...
## 85. Поясните, что такое АОП? Как реализовано в спринге?
