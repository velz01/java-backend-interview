...
## 1. Поясните, что такое инверсия контроля (IoC) и внедрение зависимостей (DI)? Как эти принципы реализованы в Spring?
...
## 3. Поясните, что такое ApplicationContext? Как работает под капотом
...
## 5. Расскажите подробнее про ApplicationContext и BeanFactory, чем отличаются? В каких случаях что стоит использовать?
...
## 6. Поясните: Жизненный цикл Bean. Вопросы связанные с классами, входящими в жизненный цикл бина
...
## 7. Поясните: @Service, @Repository, @Component
...
## 9. Поясните, чем отличаются аннотации @Bean и @Component?
...
## 10. Каким образом работает BeanPostProcessor. Почему есть before и after initialization
...
## 11. Расскажите подробнее про аннотацию @Bean?
...
## 12. Поясните: @Configuration. Является Configuration компонентом? Какую доп логику Configuration реализует?
...
## 13. Поясните: @ConfigurationProperties? ConfigurationProperties vs Value
...
## 14. Поясните: Spring Boot vs Spring
...
## 15. Поясните: Starter в Spring. Плюсы и минусы
...
## 16. Поясните, что такое SpringBoot? Какие у него преимущества? Как конфигурируется? Подробно.
...
## 17. Поясните: Dependency management в Spring boot
...
## 19. Поясните: Spring MVC. Что это? Какие проблемы решает?
...
## 20. Каким образом работает DispatcherServlet?
...
## 21. Поясните: Понятие Controller и Servlet в Java. Это одно и то же? Если разное, в чем отличия?
...
## 22. Расскажите подробнее про аннотации @Controller и @RestController. Чем они отличаются? Как вернуть ответ со своим статусом (например 213)?
...
## 23. Расскажите подробнее про паттерн Front Controller, как он реализован в Spring?
...
## 24. Расскажите подробнее про паттерн MVC, как он реализован в Spring?
...
## 26. Поясните: @Transactional. Как работает?
...
## 27. Поясните: Атрибут propagation у @Transactional
...
## 28. Поясните: Виды proxy в Spring
...
## 29. Какие именно есть атрибуты у @Transactional?
...
## 30. Поясните: @Transactional и Исключения
...
## 31. Каким образом гарантировать корректное обновление и сохранение изменений в сущностях, полученных в методе с @Transactional
...
## 32. Каким образом спринг работает с транзакциями? Расскажите про аннотацию @Transactional.
...
## 33. Поясните: Spring Security, как хранить пароль пользователя?
...
## 34. Каким образом работает Spring Security? Как сконфигурировать? Какие интерфейсы используются?
...
## 35. Поясните: @Qualifier vs @Primary
...
## 36. Поясните: Скоуп бинов. Web скоуп
...
## 37. Поясните: @Transaction Что будет если вызвать метод из метода в одном классе при различных сценариях
...
## 38. Какие именно способы внедрения зависимостей знаешь?
...
## 39. По какой причине лучше использовать конструктор?
...
## 40. Как работает аннотация @Autowired?
...
## 41. Каким образом обеспечить, чтобы при внедрении бина со скоупом prototype в singleton-бин каждый вызов получал новый экземпляр?
...
## 42. Поясните: Циклическая зависимость
...
## 45. Расскажите подробнее про жизненный цикл бина, аннотации @PostConstruct и @PreDestroy()
...
## 46. Расскажите подробнее про скоупы бинов? Какой скоуп используется по умолчанию? Что изменилось в Spring 5?
...
## 47. Поясните: Spring Criteria API
...
## 49. Поясните: Spring Profiles как с ними работать?
...
## 51. Поясните: Варианты обработки Exceptions в Spring
...
## 53. Для чего нужны аннотации @RequestParam и @PathVariable?
...
## 54. Поясните, что такое объект Filter? В какой момент вызывается?
...
## 55. Поясните: @ResponseBody vs ResponseEntity
...
## 56. Поясните: Блокировка по умолчанию в Spring
...
## 57. Поясните, в чём разница между Filters, Listeners and Interceptors?
...
## 58. Каким образом заинжектить коллекцию?
...
## 59. Каким образом заинжектить примитив?
...
## 60. Допустимо ли вставить бин в статическое поле? Почему?
...
## 61. Допустимо ли передать в запросе один и тот же параметр несколько раз? Как?
...
## 62. Расскажите подробнее про аннотацию @Conditional
...
## 63. Расскажите подробнее про аннотацию @Inject
...
## 64. Расскажите подробнее про аннотацию @Lookup
...
## 65. Расскажите подробнее про аннотацию @Profile
...
## 66. Расскажите подробнее про аннотацию @Resource
...
## 67. Расскажите подробнее про нововведения Spring 5.
...
## 68. Поясните, чем отличаются Model, ModelMap и ModelAndView?
...
## 69. Поясните, что такое ViewResolver?
...
## 70. Поясните, что такое АОП? Как реализовано в спринге?
