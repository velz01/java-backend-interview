...
## 3. Поясните, чем отличаются методы map() и flatMap()?
...
## 6. Поясните, что такое параллельные стримы?
...
## 7. Поясните: Разница между findAny() и findFirst()
...
## 8. Поясните, в чём разница между parallel и parallelStream?
...
## 9. Какие именно существуют способы создания Stream?
...
## 10. Расскажите подробнее про класс Collectors и его методы
...
## 11. Поясните, в чём разница между `Collection` и `Stream`?
