...
## 2. Какие именно существуют способы создания Stream?
...
## 3. Поясните: Типы методов в Stream API
...
## 4. Поясните, что такое терминальные методы? Какие терминальные методы в стримах вы знаете?
...
## 5. Поясните, что такое промежуточные методы? Какие промежуточные методы в стримах вы знаете?
...
## 6. Поясните, чем отличаются методы map() и flatMap()?
...
## 8. Расскажите подробнее про класс Collectors и его методы
...
## 9. Поясните, что такое параллельные стримы?
...
## 10. Поясните, в чём разница между parallel и parallelStream?
...
## 11. Поясните: Разница между findAny() и findFirst()
