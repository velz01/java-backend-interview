...
## 7. Всегда ли выполняется блок finally? Существуют ли ситуации, когда блок finally не будет выполнен?
...
## 10. Компиляция и запуск программы из командной строки
...
## 12. Области данных времени выполнения
...
## 13. Опишите иерархию исключений.
...
## 15. Почему String неизменяемый и финализированный класс?
...
## 16. Почему строки не рекомендуется использовать для хранения паролей?
...
## 19. Сколько памяти занимает boolean?
...
## 20. Случаи утечки памяти в Java
...
## 22. Что такое JDK? Что в него входит?
...
## 24. Что такое JRE? Что в него входит?
...
## 27. Что такое загрузчик классов (classloader)?
...
## 29. Что такое сборщик мусора? (Garbage collector)
