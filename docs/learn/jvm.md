...
## 5. Поясните, что такое загрузчик классов (classloader)?
...
## 9. Поясните: Области данных времени выполнения
...
## 11. Поясните, что такое сборщик мусора? (Garbage collector)
...
## 12. Поясните: Виды ссылок в Java
...
## 13. Поясните: За счет чего обеспечивается кроссплатформенность?
...
## 14. Поясните: Компиляция и запуск программы из командной строки
...
## 15. Поясните: Может ли метод main() выбросить исключение во вне и если да, то где будет происходить обработка данного исключения?
...
## 17. По какой причине String неизменяемый и финализированный класс?
...
## 18. По какой причине строки не рекомендуется использовать для хранения паролей?
...
## 19. Расскажите подробнее про классы-загрузчики и про динамическую загрузку классов.
...
## 20. Расскажите подробнее про метод main
...
## 21. Поясните: Сколько памяти занимает boolean?
...
## 22. Поясните: Случаи утечки памяти в Java
...
## 23. Поясните, что такое JDK? Что в него входит?
...
## 24. Поясните, что такое JRE? Что в него входит?
...
## 25. Поясните, что такое дефолтные методы интерфейсов? Для чего они нужны?
...
## 26. Поясните, что такое пул интов?
